...
#ifndef MINI_CHROMIUM_TESTS_COMMON_BIND_H_
#define MINI_CHROMIUM_TESTS_COMMON_BIND_H_
...
decltype(auto) BindLambdaForTesting(Lambda&& lambda) {
  static_assert(
      ...
      "binding. I.e.: cr::BindLambdaForTesting(std::move(lambda)).");
  using Signature = internal::ExtractCallableRunType<std::decay_t<Lambda>>;
...
#endif  // MINI_CHROMIUM_TESTS_COMMON_BIND_H_