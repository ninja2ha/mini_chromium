...
#ifndef MINI_CHROMIUM_SRC_TESTS_COMMON_GTEST_UTIL_H_
#define MINI_CHROMIUM_SRC_TESTS_COMMON_GTEST_UTIL_H_
...
#endif  // MINI_CHROMIUM_SRC_TESTS_COMMON_GTEST_UTIL_H_
