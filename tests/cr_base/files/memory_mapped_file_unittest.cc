...
#include "cr_base/files/memory_mapped_file.h"
...
#include "common/gtest_platform_test.h"
...
class MemoryMappedFileTest : public PlatformTest {
 protected:
  ...
  void TearDown() override { EXPECT_TRUE(cr::DeleteFile(temp_file_path_)); }
  ...
  void CreateTemporaryTestFile(size_t size) {
    ...
    size_t bytes_written =
        file.Write(0, reinterpret_cast<char*>(test_data.get()), 
