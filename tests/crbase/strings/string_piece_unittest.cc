...
template <>
class CommonStringPieceTest<wchar_t> : public ::testing::Test {
 public:
  static std::wstring as_string(const char* input) {
    return UTF8ToWide(input);
  }
  static std::wstring as_string(const std::string& input) {
    return UTF8ToWide(input);
  }
};
