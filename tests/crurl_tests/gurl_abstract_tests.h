...
#ifndef MINI_CHROMIUM_TESTS_CRURL_TESTS_GURL_ABSTRACT_TESTS_H_
#define MINI_CHROMIUM_TESTS_CRURL_TESTS_GURL_ABSTRACT_TESTS_H_
...
class AbstractUrlTest : public testing::Test {
 protected:
  ...
  UrlType CreateUrlFromString(cr::StringPiece s) {
...
#endif  // MINI_CHROMIUM_TESTS_CRURL_TESTS_GURL_ABSTRACT_TESTS_H_
