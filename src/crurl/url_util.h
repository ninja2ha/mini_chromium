...
CRURL_EXPORT void ClearSchemesForTests();
...
class CRURL_EXPORT ScopedSchemeRegistryForTests {
 public:
...
//
// Not thread-safe.
CRURL_EXPORT void EnableNonStandardSchemesForAndroidWebView();

// Whether or not SchemeHostPort and Origin allow non-standard schemes.
CRURL_EXPORT bool AllowNonStandardSchemesForAndroidWebView();
...
CRURL_EXPORT std::vector<std::string> GetStandardSchemes();

// Adds an application-defined scheme to the internal list of schemes allowed
// for referrers.
CRURL_EXPORT void AddReferrerScheme(const char* new_scheme, SchemeType scheme_type);

// Adds an application-defined scheme to the list of schemes that do not trigger
// mixed content warnings.
CRURL_EXPORT void AddSecureScheme(const char* new_scheme);
CRURL_EXPORT const std::vector<std::string>& GetSecureSchemes();
...
// to "file" URLs).
CRURL_EXPORT void AddLocalScheme(const char* new_scheme);
CRURL_EXPORT const std::vector<std::string>& GetLocalSchemes();
...
// scheme.
CRURL_EXPORT void AddNoAccessScheme(const char* new_scheme);
CRURL_EXPORT const std::vector<std::string>& GetNoAccessSchemes();

// Adds an application-defined scheme to the list of schemes that can be sent
// CORS requests.
CRURL_EXPORT void AddCorsEnabledScheme(const char* new_scheme);
CRURL_EXPORT const std::vector<std::string>& GetCorsEnabledSchemes();
...
// cannot store data.
CRURL_EXPORT void AddWebStorageScheme(const char* new_scheme);
CRURL_EXPORT const std::vector<std::string>& GetWebStorageSchemes();

// Adds an application-defined scheme to the list of schemes that can bypass the
// Content-Security-Policy (CSP) checks.
CRURL_EXPORT void AddCSPBypassingScheme(const char* new_scheme);
CRURL_EXPORT const std::vector<std::string>& GetCSPBypassingSchemes();
...
CRURL_EXPORT void AddEmptyDocumentScheme(const char* new_scheme);
CRURL_EXPORT const std::vector<std::string>& GetEmptyDocumentSchemes();
...
CRURL_EXPORT void LockSchemeRegistries();
...
CRURL_EXPORT bool FindAndCompareScheme(const char16_t* str,
                                       int str_len,
                                       const char* compare,
                                       Component* found_scheme);
...
CRURL_EXPORT bool IsStandard(const char16_t* spec, const Component& scheme);

// Returns true if the given scheme identified by |scheme| within |spec| is in
// the list of allowed schemes for referrers (see AddReferrerScheme).
CRURL_EXPORT bool IsReferrerScheme(const char* spec, const Component& scheme);
...
CRURL_EXPORT bool GetStandardSchemeType(const char* spec,
                                        ...
                                        SchemeType* type);
CRURL_EXPORT bool GetStandardSchemeType(const char16_t* spec,
                                        const Component& scheme,
                                        SchemeType* type);
...
CRURL_EXPORT
bool DomainIs(cr::StringPiece canonical_host,
              cr::StringPiece canonical_domain);

// Returns true if the hostname is an IP address. Note: this function isn't very
// cheap, as it must re-parse the host to verify.
CRURL_EXPORT bool HostIsIPAddress(cr::StringPiece host);
