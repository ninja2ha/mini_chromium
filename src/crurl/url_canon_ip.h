...
CRURL_EXPORT bool FindIPv4Components(const char16_t* spec,
                                     const Component& host,
                                     Component components[4]);
...
CRURL_EXPORT bool IPv6AddressToNumber(const char16_t* spec,
                                      const Component& host,
                                      unsigned char address[16]);
...
//
// TODO(https://crbug.com/1149194): Remove this once the bug is fixed.
CRURL_EXPORT HostSafetyStatus CheckHostnameSafety(const char* hostname,
                                                  const Component& host);
CRURL_EXPORT HostSafetyStatus CheckHostnameSafety(const char16_t* hostname,
                                                  const Component& host);
