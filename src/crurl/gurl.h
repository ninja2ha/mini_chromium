...
class CRURL_EXPORT GURL {
 public:
  typedef crurl::StringPieceReplacements<char> Replacements;
  typedef crurl::StringPieceReplacements<char16_t> ReplacementsW;
  ...
  explicit GURL(cr::StringPiece url_string);
  explicit GURL(cr::StringPiece16 url_string);
  ...
  GURL Resolve(cr::StringPiece relative) const;
  GURL Resolve(cr::StringPiece16 relative) const;
  ...
  static bool SchemeIsCryptographic(cr::StringPiece lower_ascii_scheme);
  ...
  cr::StringPiece PathForRequestPiece() const;
  ...
  cr::StringPiece HostNoBracketsPiece() const;
  ...
  static bool IsAboutPath(cr::StringPiece actual_path,
 ...
 private:
  ...
  void InitCanonical(cr::BasicStringPiece<CharT> input_spec,
                     bool trim_path_end);

  void InitializeFromCanonicalSpec();

  // Helper used by IsAboutBlank and IsAboutSrcdoc.
  bool IsAboutUrl(cr::StringPiece allowed_path) const;
...
CRURL_EXPORT bool operator==(const cr::StringPiece& spec, const GURL& x);
CRURL_EXPORT bool operator!=(const GURL& x, const cr::StringPiece& spec);
CRURL_EXPORT bool operator!=(const cr::StringPiece& spec, const GURL& x);
