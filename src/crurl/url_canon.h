...
CRURL_EXPORT extern template class CanonOutputT<char>;
CRURL_EXPORT extern template class CanonOutputT<char16_t>;
#endif
...
// left untouched.
CRURL_EXPORT const char* RemoveURLWhitespace(
    const char* input,
    int input_len,
    CanonOutputT<char>* buffer,
    int* output_len,
    bool* potentially_dangling_markup);
CRURL_EXPORT const char16_t * RemoveURLWhitespace(
...
CRURL_EXPORT bool CanonicalizeScheme(const char16_t* spec,
                                     const Component& scheme,
                                     CanonOutput* output,
                                     Component* out_scheme);
...
CRURL_EXPORT bool CanonicalizeUserInfo(const char16_t* username_source,
                                       const Component& username,
...
CRURL_EXPORT bool CanonicalizeHost(const char* spec,
                                   ...
                                   CanonOutput* output,
                                   Component* out_host);
CRURL_EXPORT bool CanonicalizeHost(const char16_t* spec,
                                   const Component& host,
                                   CanonOutput* output,
                                   Component* out_host);
...
CRURL_EXPORT void CanonicalizeHostVerbose(const char16_t* spec,
                                          const Component& host,
                                          CanonOutput* output,
                                          CanonHostInfo* host_info);
...
CRURL_EXPORT bool CanonicalizeHostSubstring(const char* spec,
                                            const Component& host,
                                            CanonOutput* output);
CRURL_EXPORT bool CanonicalizeHostSubstring(const char16_t* spec,
                                            const Component& host,
                                            CanonOutput* output);
...
CRURL_EXPORT void CanonicalizeIPAddress(const char* spec,
                                        ...
                                        CanonOutput* output,
                                        CanonHostInfo* host_info);
CRURL_EXPORT void CanonicalizeIPAddress(const char16_t* spec,
                                        const Component& host,
                                        CanonOutput* output,
                                        CanonHostInfo* host_info);
...
CRURL_EXPORT bool CanonicalizePort(const char* spec,
                                   ...
                                   CanonOutput* output,
                                   Component* out_port);
CRURL_EXPORT bool CanonicalizePort(const char16_t* spec,
                                   const Component& port,
                                   int default_port_for_scheme,
                                   CanonOutput* output,
                                   Component* out_port);
...
CRURL_EXPORT bool CanonicalizePath(const char* spec,
                                   ...
                                   CanonOutput* output,
                                   Component* out_path);
CRURL_EXPORT bool CanonicalizePath(const char16_t* spec,
                                   const Component& path,
                                   CanonOutput* output,
                                   Component* out_path);
...
CRURL_EXPORT bool CanonicalizePartialPath(const char* spec,
                                          const Component& path,
                                          CanonOutput* output,
                                          Component* out_path);
CRURL_EXPORT bool CanonicalizePartialPath(const char16_t* spec,
                                          const Component& path,
                                          CanonOutput* output,
                                          Component* out_path);
...
CRURL_EXPORT bool FileCanonicalizePath(const char* spec,
                                       ...
                                       CanonOutput* output,
                                       Component* out_path);
CRURL_EXPORT bool FileCanonicalizePath(const char16_t* spec,
                                       const Component& path,
                                       CanonOutput* output,
                                       Component* out_path);
...
CRURL_EXPORT void CanonicalizeQuery(const char* spec,
                                    ...
                                    CanonOutput* output,
                                    Component* out_query);
CRURL_EXPORT void CanonicalizeQuery(const char16_t* spec,
                                    const Component& query,
                                    CharsetConverter* converter,
                                    CanonOutput* output,
                                    Component* out_query);
...
CRURL_EXPORT void CanonicalizeRef(const char* spec,
                                  ...
                                  CanonOutput* output,
                                  Component* out_path);
CRURL_EXPORT void CanonicalizeRef(const char16_t* spec,
                                  const Component& path,
                                  CanonOutput* output,
                                  Component* out_path);
...
CRURL_EXPORT bool CanonicalizeStandardURL(const char* spec,
                                          ...
                                          CanonOutput* output,
                                          Parsed* new_parsed);
CRURL_EXPORT bool CanonicalizeStandardURL(const char16_t* spec,
                                          int spec_len,
                                          const Parsed& parsed,
                                          SchemeType scheme_type,
                                          CharsetConverter* query_converter,
...
CRURL_EXPORT bool CanonicalizeFileURL(const char* spec,
                                      ...
                                      CanonOutput* output,
                                      Parsed* new_parsed);
CRURL_EXPORT bool CanonicalizeFileURL(const char16_t* spec,
                                     int spec_len,
                                     const Parsed& parsed,
                                     CharsetConverter* query_converter,
                                     CanonOutput* output,
...
CRURL_EXPORT bool CanonicalizeFileSystemURL(const char* spec,
                                            ...
                                            CanonOutput* output,
                                            Parsed* new_parsed);
CRURL_EXPORT bool CanonicalizeFileSystemURL(const char16_t* spec,
                                            int spec_len,
                                            const Parsed& parsed,
                                            CharsetConverter* query_converter,
                                            CanonOutput* output,
...
CRURL_EXPORT bool CanonicalizePathURL(const char* spec,
                                      ...
                                      CanonOutput* output,
                                      Parsed* new_parsed);
CRURL_EXPORT bool CanonicalizePathURL(const char16_t* spec,
                                      int spec_len,
                                      const Parsed& parsed,
                                      CanonOutput* output,
                                      Parsed* new_parsed);
...
CRURL_EXPORT void CanonicalizePathURLPath(const char* source,
                                          const Component& component,
                                          CanonOutput* output,
                                          Component* new_component);
CRURL_EXPORT void CanonicalizePathURLPath(const char16_t* source,
                                          const Component& component,
                                          CanonOutput* output,
                                          Component* new_component);
...
CRURL_EXPORT bool CanonicalizeMailtoURL(const char* spec,
                                        ...
                                        CanonOutput* output,
                                        Parsed* new_parsed);
CRURL_EXPORT bool CanonicalizeMailtoURL(const char16_t* spec,
                                        int spec_len,
                                        const Parsed& parsed,
                                        CanonOutput* output,
                                        Parsed* new_parsed);
