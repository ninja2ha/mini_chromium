...
CRURL_EXPORT bool ReadUTFChar(const char* str,
                              int* begin,
                              int length,
...
CRURL_EXPORT bool ReadUTFChar(const char16_t* str,
                              int* begin,
                              int length,
                              unsigned* code_point_out);
...
// normal.
CRURL_EXPORT bool ConvertUTF16ToUTF8(const char16_t* input,
                                     int input_len,
                                     CanonOutput* output);
CRURL_EXPORT bool ConvertUTF8ToUTF16(const char* input,
                                     int input_len,
                                     CanonOutputT<char16_t>* output);
