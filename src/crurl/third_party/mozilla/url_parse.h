...
#ifndef MINI_CHROMIUM_SRC_CRURL_THIRD_PARTY_MOZILLA_URL_PARSE_H_
#define MINI_CHROMIUM_SRC_CRURL_THIRD_PARTY_MOZILLA_URL_PARSE_H_
...
CRURL_EXPORT void ParseStandardURL(const char* url, 
                                   int url_len, 
                                   Parsed* parsed);
CRURL_EXPORT void ParseStandardURL(const char16_t *url, 
                                   int url_len,
                                   Parsed *parsed);
...
CRURL_EXPORT void ParsePathURL(const char *url, 
                               ...
                               bool trim_path_end,
                               Parsed *parsed);
CRURL_EXPORT void ParsePathURL(const char16_t *url, 
                               int url_len,
                               bool trim_path_end, 
                               Parsed *parsed);
...
CRURL_EXPORT void ParseFileURL(const char16_t *url, 
                               int url_len,
                               Parsed *parsed);
...
CRURL_EXPORT void ParseFileSystemURL(const char *url, 
                                     int url_len,
                                     Parsed *parsed);
CRURL_EXPORT void ParseFileSystemURL(const char16_t *url, 
                                     int url_len,
                                     Parsed *parsed);

// MailtoURL is for mailto: urls. They are made up scheme,path,query
CRURL_EXPORT void ParseMailtoURL(const char* url, 
                                 int url_len, 
                                 Parsed* parsed);
CRURL_EXPORT void ParseMailtoURL(const char16_t *url, 
                                 int url_len,
                                 Parsed *parsed);
...
CRURL_EXPORT bool ExtractScheme(const char *url, 
                                int url_len,
                                Component *scheme);
CRURL_EXPORT bool ExtractScheme(const char16_t *url, 
                                int url_len,
                                Component *scheme);

// Returns true if ch is a character that terminates the authority segment
// of a URL.
CRURL_EXPORT bool IsAuthorityTerminator(char16_t ch);
...
CRURL_EXPORT void ParseAuthority(const char *spec, 
                                 ...
                                 Component *hostname, 
                                 Component *port_num);
CRURL_EXPORT void ParseAuthority(const char16_t* spec,
                                 const Component& auth,
                                 Component* username,
                                 Component* password,
                                 Component* hostname,
...
CRURL_EXPORT int ParsePort(const char16_t* url, const Component& port);
...
CRURL_EXPORT void ExtractFileName(const char* url,
                                  ...
                                  Component* file_name);
CRURL_EXPORT void ExtractFileName(const char16_t* url,
                                  const Component& path,
                                  Component* file_name);
...
CRURL_EXPORT bool ExtractQueryKeyValue(const char* url,
                                       ...
                                       Component* key,
                                       Component* value);
CRURL_EXPORT bool ExtractQueryKeyValue(const char16_t* url,
                                       Component* query,
                                       Component* key,
                                       Component* value);
...
#endif  // MINI_CHROMIUM_SRC_CRURL_THIRD_PARTY_MOZILLA_URL_PARSE_H_
