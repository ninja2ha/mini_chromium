  ...
  class FdWatchControllerInterface {
   public:
    FdWatchControllerInterface(
        const FdWatchControllerInterface&) = delete;
    FdWatchControllerInterface& operator=(
        const FdWatchControllerInterface&) = delete;
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_PUMP_WATCHABLE_IO_MESSAGE_PUMP_POSIX_H_