...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_PUMP_MESSAGE_PUMP_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_PUMP_MESSAGE_PUMP_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_PUMP_MESSAGE_PUMP_H_