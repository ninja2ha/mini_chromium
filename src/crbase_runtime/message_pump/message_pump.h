...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_LOOP_MESSAGE_PUMP_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_LOOP_MESSAGE_PUMP_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_LOOP_MESSAGE_PUMP_H_
