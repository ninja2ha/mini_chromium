...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_THREADING_THREAD_CHECKER_IMPL_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_THREADING_THREAD_CHECKER_IMPL_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_THREADING_THREAD_CHECKER_IMPL_H_