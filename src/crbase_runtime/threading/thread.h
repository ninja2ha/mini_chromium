...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_THREADING_THREAD_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_THREADING_THREAD_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_THREADING_THREAD_H_