...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_THREADING_SEQUENCE_LOCAL_STORAGE_SLOT_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_THREADING_SEQUENCE_LOCAL_STORAGE_SLOT_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_THREADING_SEQUENCE_LOCAL_STORAGE_SLOT_H_