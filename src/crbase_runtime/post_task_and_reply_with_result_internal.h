...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_POST_TASK_AND_REPLY_WITH_RESULT_INTERNAL_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_POST_TASK_AND_REPLY_WITH_RESULT_INTERNAL_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_POST_TASK_AND_REPLY_WITH_RESULT_INTERNAL_H_