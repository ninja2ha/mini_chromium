...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_TASK_CURRENT_THREAD_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_TASK_CURRENT_THREAD_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_TASK_CURRENT_THREAD_H_
