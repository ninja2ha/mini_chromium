...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_TASK_COMMON_OPERATIONS_CONTROLLER_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_TASK_COMMON_OPERATIONS_CONTROLLER_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_TASK_COMMON_OPERATIONS_CONTROLLER_H_
