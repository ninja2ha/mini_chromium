...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_TASK_SINGLE_THREAD_TASK_RUNNER_THREAD_MODE_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_TASK_SINGLE_THREAD_TASK_RUNNER_THREAD_MODE_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_TASK_SINGLE_THREAD_TASK_RUNNER_THREAD_MODE_H_
