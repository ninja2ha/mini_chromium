...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_TASK_TASK_TRAITS_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_TASK_TASK_TRAITS_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_TASK_TASK_TRAITS_H_
