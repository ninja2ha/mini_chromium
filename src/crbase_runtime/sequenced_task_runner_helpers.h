...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_SEQUENCED_TASK_RUNNER_HELPERS_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_SEQUENCED_TASK_RUNNER_HELPERS_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_SEQUENCED_TASK_RUNNER_HELPERS_H_