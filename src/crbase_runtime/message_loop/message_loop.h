...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_LOOP_MESSAGE_LOOP_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_LOOP_MESSAGE_LOOP_H_
...
class CRBASE_EXPORT MessageLoop : public MessagePump::Delegate,
 ...
 private:
  ...
  friend class Thread;
  CR_FRIEND_GTEST_ALL_PREFIXES(MessageLoopTest, DeleteUnboundLoop);
  ...
  const RefPtr<internal::MessageLoopTaskRunner> underlying_task_runner_;
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_LOOP_MESSAGE_LOOP_H_