...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_LOOP_SEQUENCED_TASK_SOURCE_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_LOOP_SEQUENCED_TASK_SOURCE_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_LOOP_SEQUENCED_TASK_SOURCE_H_