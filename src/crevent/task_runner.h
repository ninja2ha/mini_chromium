...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_RUNNER_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_RUNNER_H_
...
#include "crevent/internal/post_task_and_reply_with_result_internal.h"
...
class CREVENT_EXPORT TaskRunner
...
struct CREVENT_EXPORT TaskRunnerTraits {
  static void Destruct(const TaskRunner* task_runner);
};

}  // namespace cr

#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_RUNNER_H_