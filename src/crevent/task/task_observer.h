...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_TASK_OBSERVER_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_TASK_OBSERVER_H_
...
class CREVENT_EXPORT TaskObserver {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_TASK_OBSERVER_H_
