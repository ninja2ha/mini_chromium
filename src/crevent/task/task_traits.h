...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_TASK_TRAITS_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_TASK_TRAITS_H_
...
#include "crevent/task/task_traits_extension.h"
#include "crevent/traits_bag.h"
...
// - cr::WaitableEvent::Wait
// - cr::ConditionVariable::Wait
// - cr::PlatformThread::Join
// - cr::PlatformThread::Sleep
// - cr::Process::WaitForExit
// - cr::Process::WaitForExitWithTimeout
//
...
class CREVENT_EXPORT TaskTraits {
 public:
 ...
 private:
  ...
  TaskTraits(TaskPriority priority,
    ...
    CR_DCHECK(use_thread_pool_ ^ has_extension);
  }
...
CREVENT_EXPORT const char* TaskPriorityToString(TaskPriority task_priority);
CREVENT_EXPORT const char* TaskShutdownBehaviorToString(
...
CREVENT_EXPORT std::ostream& operator<<(
    std::ostream& os,
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_TASK_TRAITS_H_
