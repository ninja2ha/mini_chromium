...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_TASK_TRAITS_EXTENSION_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_TASK_TRAITS_EXTENSION_H_
...
struct CREVENT_EXPORT TaskTraitsExtensionStorage {
  // Size in bytes.
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_TASK_TRAITS_EXTENSION_H_
