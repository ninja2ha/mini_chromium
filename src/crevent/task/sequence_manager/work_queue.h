...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_WORK_QUEUE_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_WORK_QUEUE_H_
...
class CREVENT_EXPORT WorkQueue {
 public:
  ...
  class CREVENT_EXPORT TaskPusher {
   public:
  ...
  cr::internal::HeapHandle heap_handle() const { return heap_handle_; }

  void set_heap_handle(cr::internal::HeapHandle handle) {
    heap_handle_ = handle;
  }
 ...
 private:
  ...
  cr::internal::HeapHandle heap_handle_;
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_WORK_QUEUE_H_
