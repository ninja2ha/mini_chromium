...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_TASK_QUEUE_SELECTOR_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_TASK_QUEUE_SELECTOR_H_

#include <stddef.h>

#include <vector>

#include "crevent/event_export.h"
...
#include "crevent/task/sequence_manager/task_queue_selector_logic.h"
...
class CREVENT_EXPORT TaskQueueSelector : public WorkQueueSets::Observer {
 public:
  using SelectTaskOption = SequencedTaskSource::SelectTaskOption;

  TaskQueueSelector(RefPtr<AssociatedThreadId> associated_thread,
 ...
 protected:
  ...
  class CREVENT_EXPORT ActivePriorityTracker {
   public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_TASK_QUEUE_SELECTOR_H_
