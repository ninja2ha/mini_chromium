...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_ATOMIC_FLAG_SET_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_ATOMIC_FLAG_SET_H_
...
class CREVENT_EXPORT AtomicFlagSet {
 protected:
  struct Group;

 public:
  explicit AtomicFlagSet(RefPtr<AssociatedThreadId> associated_thread);
  ...
  class CREVENT_EXPORT AtomicFlag {
   public:
    AtomicFlag();
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_ATOMIC_FLAG_SET_H_
