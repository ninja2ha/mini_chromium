...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_THREAD_CONTROLLER_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_THREAD_CONTROLLER_H_
...
class CREVENT_EXPORT ThreadController {
 public:
  ...
  // ThreadController.
  virtual void SetDefaultTaskRunner(RefPtr<SingleThreadTaskRunner>) = 0;
  ...
  virtual RefPtr<SingleThreadTaskRunner> GetDefaultTaskRunner() = 0;
  ...
  virtual const RefPtr<AssociatedThreadId>& GetAssociatedThread()
      const = 0;
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_THREAD_CONTROLLER_H_
