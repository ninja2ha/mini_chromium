...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_WORK_QUEUE_SETS_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_WORK_QUEUE_SETS_H_
...
class CREVENT_EXPORT WorkQueueSets {
 public:
 ...
 private:
  struct OldestTaskEnqueueOrder {
    ...
    void SetHeapHandle(cr::internal::HeapHandle handle) {
      value->set_heap_handle(handle);
    }

    void ClearHeapHandle() {
      value->set_heap_handle(cr::internal::HeapHandle());
    }
  ...
  std::array<cr::internal::IntrusiveHeap<OldestTaskEnqueueOrder>,
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_WORK_QUEUE_SETS_H_
