...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_THREAD_CONTROLLER_IMPL_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_THREAD_CONTROLLER_IMPL_H_
...
///#include "crevent/task/common/task_annotator.h"
...
class CREVENT_EXPORT ThreadControllerImpl : public ThreadController,
 ...
 public:
  ...
  void SetDefaultTaskRunner(RefPtr<SingleThreadTaskRunner>) override;
 ...
 private:
  ...
  RefPtr<SingleThreadTaskRunner> message_loop_task_runner_;
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_THREAD_CONTROLLER_IMPL_H_
