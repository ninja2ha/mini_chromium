...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_TIME_DOMAIN_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_TIME_DOMAIN_H_
...
class CREVENT_EXPORT TimeDomain {
 public:
 ...
 private:
  ...
  struct ScheduledDelayedWakeUp {
    ...
    void ClearHeapHandle() {
      ...
      queue->set_heap_handle(cr::internal::HeapHandle());
    }
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_TIME_DOMAIN_H_
