...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_CHECKED_LOCK_IMPL_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_CHECKED_LOCK_IMPL_H_
...
class CREVENT_EXPORT CheckedLockImpl {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_CHECKED_LOCK_IMPL_H_
