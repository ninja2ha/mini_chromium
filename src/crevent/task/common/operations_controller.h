...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_OPERATIONS_CONTROLLER_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_OPERATIONS_CONTROLLER_H_
...
class CREVENT_EXPORT OperationsController {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_OPERATIONS_CONTROLLER_H_
