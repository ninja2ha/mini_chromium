...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_SCOPED_DEFER_TASK_POSTING_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_SCOPED_DEFER_TASK_POSTING_H_
...
class CREVENT_EXPORT ScopedDeferTaskPosting {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_SCOPED_DEFER_TASK_POSTING_H_
