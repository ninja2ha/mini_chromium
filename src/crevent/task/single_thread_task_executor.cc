...
#include "crevent/task/single_thread_task_executor.h"
...
SingleThreadTaskExecutor::SingleThreadTaskExecutor(MessagePumpType type)
  ...
  CR_DCHECK(type != MessagePumpType::CUSTOM);
}
...
RefPtr<SingleThreadTaskRunner> SingleThreadTaskExecutor::task_runner()
    const {
