...
#ifndef MINI_CHROMIUM_SRC_CREVENT_MESSAGE_LOOP_PENDING_TASK_H_
#define MINI_CHROMIUM_SRC_CREVENT_MESSAGE_LOOP_PENDING_TASK_H_
...
struct CREVENT_EXPORT PendingTask {
  PendingTask();
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_MESSAGE_LOOP_PENDING_TASK_H_