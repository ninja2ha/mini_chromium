...
#ifndef MINI_CHROMIUM_SRC_CREVENT_WIN_MESSAGE_WINDOW_H_
#define MINI_CHROMIUM_SRC_CREVENT_WIN_MESSAGE_WINDOW_H_
...
class CREVENT_EXPORT MessageWindow {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_WIN_MESSAGE_WINDOW_H_