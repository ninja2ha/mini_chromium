...
#ifndef MINI_CHROMIUM_SRC_CREVENT_WIN_OBJECT_WATCHER_H_
#define MINI_CHROMIUM_SRC_CREVENT_WIN_OBJECT_WATCHER_H_
...
class CREVENT_EXPORT ObjectWatcher {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_WIN_OBJECT_WATCHER_H_