...
#ifndef MINI_CHROMIUM_SRC_CREVENT_SINGLE_THREAD_TASK_RUNNER_H_
#define MINI_CHROMIUM_SRC_CREVENT_SINGLE_THREAD_TASK_RUNNER_H_
...
class CREVENT_EXPORT SingleThreadTaskRunner : public SequencedTaskRunner {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_SINGLE_THREAD_TASK_RUNNER_H_