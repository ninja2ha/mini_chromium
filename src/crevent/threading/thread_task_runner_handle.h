...
#ifndef MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_TASK_RUNNER_HANDLE_H_
#define MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_TASK_RUNNER_HANDLE_H_
...
class CREVENT_EXPORT ThreadTaskRunnerHandle {
 public:
...
class CREVENT_EXPORT ThreadTaskRunnerHandleOverride {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_TASK_RUNNER_HANDLE_H_