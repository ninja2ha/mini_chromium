...
#ifndef MINI_CHROMIUM_SRC_CREVENT_THREADING_SEQUENCE_LOCAL_STORAGE_MAP_H_
#define MINI_CHROMIUM_SRC_CREVENT_THREADING_SEQUENCE_LOCAL_STORAGE_MAP_H_
...
class CREVENT_EXPORT SequenceLocalStorageMap {
 public:
  ...
  class CREVENT_EXPORT ValueDestructorPair {
   public:
...
class CREVENT_EXPORT ScopedSetSequenceLocalStorageMapForCurrentThread {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_THREADING_SEQUENCE_LOCAL_STORAGE_MAP_H_