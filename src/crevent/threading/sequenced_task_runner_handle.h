...
#ifndef MINI_CHROMIUM_SRC_CREVENT_THREADING_SEQUENCED_TASK_RUNNER_HANDLE_H_
#define MINI_CHROMIUM_SRC_CREVENT_THREADING_SEQUENCED_TASK_RUNNER_HANDLE_H_
...
class CREVENT_EXPORT SequencedTaskRunnerHandle {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_THREADING_SEQUENCED_TASK_RUNNER_HANDLE_H_