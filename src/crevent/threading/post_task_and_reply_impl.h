...
#ifndef MINI_CHROMIUM_SRC_CREVENT_THREADING_POST_TASK_AND_REPLY_IMPL_H_
#define MINI_CHROMIUM_SRC_CREVENT_THREADING_POST_TASK_AND_REPLY_IMPL_H_
...
class CREVENT_EXPORT PostTaskAndReplyImpl {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_THREADING_POST_TASK_AND_REPLY_IMPL_H_