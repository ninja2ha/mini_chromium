...
#ifndef MINI_CHROMIUM_SRC_CREVENT_RUN_LOOP_H_
#define MINI_CHROMIUM_SRC_CREVENT_RUN_LOOP_H_
...
class CREVENT_EXPORT RunLoop {
 public:
  ...
  class CREVENT_EXPORT NestingObserver {
   public:
  ...
  class CREVENT_EXPORT Delegate {
   ...
   private:
    ...
    using RunLoopStack = cr::Stack<RunLoop*, std::vector<RunLoop*>>;
  ...
  class CREVENT_EXPORT ScopedDisallowRunning {
   public:
  ...
  struct CREVENT_EXPORT RunLoopTimeout {
    RunLoopTimeout();
    ~RunLoopTimeout();
    TimeDelta timeout;
 ...
 private:
  CR_FRIEND_GTEST_ALL_PREFIXES(SingleThreadTaskExecutorTypedTest,
  ...
  const RefPtr<SingleThreadTaskRunner> origin_task_runner_;
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_RUN_LOOP_H_