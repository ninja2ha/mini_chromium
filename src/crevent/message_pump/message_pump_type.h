...
#ifndef MINI_CHROMIUM_SRC_CREVENT_MESSAGE_PUMP_MESSAGE_PUMP_TYPE_H_
#define MINI_CHROMIUM_SRC_CREVENT_MESSAGE_PUMP_MESSAGE_PUMP_TYPE_H_
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_MESSAGE_PUMP_MESSAGE_PUMP_TYPE_H_
