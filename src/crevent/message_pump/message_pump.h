...
#ifndef MINI_CHROMIUM_SRC_CREVENT_MESSAGE_LOOP_MESSAGE_PUMP_H_
#define MINI_CHROMIUM_SRC_CREVENT_MESSAGE_LOOP_MESSAGE_PUMP_H_
...
class CREVENT_EXPORT MessagePump {
 public:
   ...
   public:
    ...
    struct NextWorkInfo {
      ...
      TimeDelta remaining_delay() const {
        CR_DCHECK(!delayed_run_time.is_null() && !delayed_run_time.is_max());
        CR_DCHECK(TimeTicks::Now() >= recent_now);
    ...
    ScopedDoNativeWork BeginNativeWork() CR_WARN_UNUSED_RESULT {
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_MESSAGE_LOOP_MESSAGE_PUMP_H_
