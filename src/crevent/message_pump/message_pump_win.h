...
#ifndef MINI_CHROMIUM_SRC_CREVENT_MESSAGE_LOOP_MESSAGE_PUMP_WIN_H_
#define MINI_CHROMIUM_SRC_CREVENT_MESSAGE_LOOP_MESSAGE_PUMP_WIN_H_
...
#include "crevent/win/message_window.h"
...
class CREVENT_EXPORT MessagePumpWin : public MessagePump {
 public:
  MessagePumpWin();
...
//
class CREVENT_EXPORT MessagePumpForUI : public MessagePumpWin {
 public:
  MessagePumpForUI();
 ...
 private:
  ...
  cr::win::MessageWindow message_window_;
...
//
class CREVENT_EXPORT MessagePumpForIO : public MessagePumpWin {
 public:
  struct CREVENT_EXPORT IOContext {
    IOContext();
  ...
  //     }
  //
  class CREVENT_EXPORT IOHandler {
   public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_MESSAGE_LOOP_MESSAGE_PUMP_WIN_H_
