...
#ifndef MINI_CHROMIUM_SRC_CREVENT_MESSAGE_PUMP_WORK_ID_PROVIDER_H_
#define MINI_CHROMIUM_SRC_CREVENT_MESSAGE_PUMP_WORK_ID_PROVIDER_H_
...
class CREVENT_EXPORT WorkIdProvider {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_MESSAGE_PUMP_WORK_ID_PROVIDER_H_
