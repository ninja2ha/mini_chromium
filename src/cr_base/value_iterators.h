...
#ifndef MINI_CHROMIUM_SRC_CRBASE_VALUE_ITERATORS_H_
#define MINI_CHROMIUM_SRC_CRBASE_VALUE_ITERATORS_H_
...
using DictStorage = cr::FlatMap<std::string, std::unique_ptr<Value>>;
...
class CRBASE_EXPORT dict_iterator {
 public:
  ...
  CRBASE_EXPORT friend bool operator==(const dict_iterator& lhs,
...
// access without incurring a copy.
class CRBASE_EXPORT const_dict_iterator {
 public:
  ...
  CRBASE_EXPORT friend bool operator==(const const_dict_iterator& lhs,
...
// const-qualification.
class CRBASE_EXPORT dict_iterator_proxy {
 public:
...
class CRBASE_EXPORT const_dict_iterator_proxy {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_VALUE_ITERATORS_H_