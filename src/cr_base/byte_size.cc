...
constexpr uint64_t kOneKiB = KiBU(1u).InBytes();
constexpr uint64_t kOneMiB = MiBU(1u).InBytes();
constexpr uint64_t kOneGiB = GiBU(1u).InBytes();
constexpr uint64_t kOneTiB = TiBU(1u).InBytes();
constexpr uint64_t kOnePiB = PiBU(1u).InBytes();
constexpr uint64_t kOneEiB = EiBU(1u).InBytes();
