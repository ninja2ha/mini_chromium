...
#include "cr_base/strings/string_piece.h"  // For implicit conversions.

namespace cr {

////////////////////////////////////////////////////////////////////////////////
// ASCII-specific lower/upper converter
...
CRBASE_EXPORT extern const char16_t kWhitespaceASCIIAsUTF16[];  // No unicode.
CRBASE_EXPORT extern const char32_t kWhitespaceASCIIAsUTF32[];  // No unicode.
...
// Unicode w/o CR/LF.
CRBASE_EXPORT extern const char16_t kWhitespaceNoCrLfUTF16[];
CRBASE_EXPORT extern const char32_t kWhitespaceNoCrLfUTF32[];
...
// |characters|.
CRBASE_EXPORT bool ContainsOnlyChars(StringPiece input, 
                                     StringPiece characters);
...
// CR_DCHECKs in debug builds if not.
...
int vsnprintf(char* buffer, size_t size, const char* format, 
              va_list arguments) CR_WPRINTF_FORMAT(3, 0);
int vsnwprintf(wchar_t* buffer, size_t size, const wchar_t* format, 
               va_list arguments) CR_WPRINTF_FORMAT(3, 0);
...
int snwprintf(wchar_t* buffer, size_t size, const wchar_t* format, ...)
    CR_WPRINTF_FORMAT(3, 4);

// Chromium code style is to not use malloc'd strings; this is only for use
// for interaction with APIs that require it.
char* strdup(const char* str) CR_WARN_UNUSED_RESULT;
wchar_t* wcsdup(const wchar_t* str) CR_WARN_UNUSED_RESULT;
...
inline int snwprintf(wchar_t* buffer, size_t size, const wchar_t* format, ...) {
  va_list arguments;
  va_start(arguments, format);
...
inline wchar_t* AsWide(char16_t* str) {
  return reinterpret_cast<wchar_t*>(str);
}

inline wchar_t* AsWide(std::u16string& str) {
  return reinterpret_cast<wchar_t*>(data(str));
}

inline const wchar_t* AsConstWide(const char16_t* str) {
  return reinterpret_cast<const wchar_t*>(str);
}

inline const wchar_t* AsConstWide(StringPiece16 str) {
...
inline char16_t* AsUnicode16(std::wstring& str) {
  return reinterpret_cast<char16_t*>(data(str));
}

inline const char16_t* AsConstUnicode16(const wchar_t* str) {
...
inline wchar_t* AsWide(char32_t* str) {
  return reinterpret_cast<wchar_t*>(str);
}

inline wchar_t* AsWide(std::u32string& str) {
  return reinterpret_cast<wchar_t*>(data(str));
}

inline const wchar_t* AsConstWide(const char32_t* str) {
  return reinterpret_cast<const wchar_t*>(str);
}

inline const wchar_t* AsConstWide(StringPiece32 str) {
  return reinterpret_cast<const wchar_t*>(str.data());
}
...
inline char32_t* AsUnicode32(std::wstring& str) {
  return reinterpret_cast<char32_t*>(data(str));
}

inline const char32_t* AsConstUnicode32(const wchar_t* str) {
