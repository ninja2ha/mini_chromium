...
#include "cr_base/strings/internal/string_util_internal.h"
...
TrimPositions TrimWhitespaceASCII(StringPiece input,
                                  TrimPositions positions,
                                  std::string* output) {
  return internal::TrimStringT(input, StringPiece(kWhitespaceASCII), 
                               positions, output);
}
...
TrimPositions TrimWhitespace(StringPiece32 input,
                             TrimPositions positions,
                             std::u32string* output) {
  return internal::TrimStringT(input, StringPiece32(kWhitespaceUTF32),
                               positions, output);
}

StringPiece32 TrimWhitespace(StringPiece32 input,
                             TrimPositions positions) {
  return internal::TrimStringPieceT(input, StringPiece32(kWhitespaceUTF32), 
                                    positions);
}
...
TrimPositions TrimWhitespace(WStringPiece input,
                             TrimPositions positions,
                             std::wstring* output) {
  return internal::TrimStringT(input, WStringPiece(kWhitespaceWide), 
                               positions, output);
}

WStringPiece TrimWhitespace(WStringPiece input, 
                            TrimPositions positions) {
