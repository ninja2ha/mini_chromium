...
//
// To join an array of strings with a separator, see cr::JoinString in below.
//
// MORE INFO
//
...
CRBASE_EXPORT std::string JoinString(
    Span<const std::string> parts,
    StringPiece separator) CR_WARN_UNUSED_RESULT;
CRBASE_EXPORT std::u16string JoinString(
    Span<const std::u16string> parts,
    StringPiece16 separator) CR_WARN_UNUSED_RESULT;
CRBASE_EXPORT std::u32string JoinString(
    Span<const std::u32string> parts,
    StringPiece32 separator) CR_WARN_UNUSED_RESULT;
CRBASE_EXPORT std::wstring JoinString(
    Span<const std::wstring> parts,
    WStringPiece separator) CR_WARN_UNUSED_RESULT;

CRBASE_EXPORT std::string JoinString(
    Span<const StringPiece> parts,
    StringPiece separator) CR_WARN_UNUSED_RESULT;
CRBASE_EXPORT std::u16string JoinString(
    Span<const StringPiece16> parts,
    StringPiece16 separator) CR_WARN_UNUSED_RESULT;
CRBASE_EXPORT std::u32string JoinString(
    Span<const StringPiece32> parts,
    StringPiece32 separator) CR_WARN_UNUSED_RESULT;
CRBASE_EXPORT std::wstring JoinString(
    Span<const WStringPiece> parts,
    WStringPiece separator) CR_WARN_UNUSED_RESULT;

// Explicit initializer_list overloads are required to break ambiguity when used
// with a literal initializer list (otherwise the compiler would not be able to
// decide between the string and StringPiece overloads).
inline std::string JoinString(std::initializer_list<StringPiece> parts,
                              StringPiece separator) {
  return JoinString(MakeSpan(parts), separator);
}

inline std::u16string JoinString(std::initializer_list<StringPiece16> parts,
                                 StringPiece16 separator) {
  return JoinString(MakeSpan(parts), separator);
}

inline std::u32string JoinString(std::initializer_list<StringPiece32> parts,
                                 StringPiece32 separator) {
  return JoinString(MakeSpan(parts), separator);
}

inline std::wstring JoinString(std::initializer_list<WStringPiece> parts,
