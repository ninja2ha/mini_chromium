...
#ifndef MINI_CHROMIUM_SRC_CRBASE_STRINGS_INTERNAL_STRING_NUMBER_CONVERSIONS_INTERNAL_H_
#define MINI_CHROMIUM_SRC_CRBASE_STRINGS_INTERNAL_STRING_NUMBER_CONVERSIONS_INTERNAL_H_
...
#include "cr_base/third_party/double_conversion/double-conversion/double-conversion.h"
...
bool StringToDoubleImpl(STRING input, const CHAR* data, double& output) {
  ...
  // UNSAFE: static_cast<int>
  int processed_characters_count;
  output = converter->StringToDouble(data, static_cast<int>(input.size()),
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_STRINGS_INTERNAL_STRING_NUMBER_CONVERSIONS_INTERNAL_H_
