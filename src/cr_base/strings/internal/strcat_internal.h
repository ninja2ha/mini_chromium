...
#ifndef MINI_CHROMIUM_SRC_CRBASE_STRINGS_INTERNAL_STRCAT_INTERNAL_H_
#define MINI_CHROMIUM_SRC_CRBASE_STRINGS_INTERNAL_STRCAT_INTERNAL_H_
...
auto Resize(std::basic_string<CharT>& str, 
            size_t total_size, 
            cr::internal::priority_tag<1>)
...
template <typename CharT>
void Resize(std::basic_string<CharT>& str, 
            size_t total_size, 
            cr::internal::priority_tag<0>) {
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_STRINGS_INTERNAL_STRCAT_INTERNAL_H_