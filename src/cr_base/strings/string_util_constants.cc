...
const char16_t kWhitespaceASCIIAsUTF16[] = { WHITESPACE_ASCII, 0 };
const char32_t kWhitespaceASCIIAsUTF32[] = {WHITESPACE_ASCII, 0};
...
const wchar_t* kWhitespaceWide = reinterpret_cast<const wchar_t*>(kWhitespaceUTF16);
#else
const wchar_t* kWhitespaceWide = reinterpret_cast<const wchar_t*>(kWhitespaceUTF32);
#endif

const char16_t kWhitespaceNoCrLfUTF16[] = { WHITESPACE_UNICODE_NO_CR_LF, 0 };
const char32_t kWhitespaceNoCrLfUTF32[] = {WHITESPACE_UNICODE_NO_CR_LF, 0};
