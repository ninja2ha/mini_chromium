...
#ifndef MINI_CHROMIUM_SRC_CRBASE_UTIL_SCOPED_GENERIC_H_
#define MINI_CHROMIUM_SRC_CRBASE_UTIL_SCOPED_GENERIC_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_UTIL_SCOPED_GENERIC_H_
