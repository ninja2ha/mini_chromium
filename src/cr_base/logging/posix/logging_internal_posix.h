...
#ifndef MINI_CHROMIUM_SRC_CRBASE_LOGGING_LOGGING_INTERNAL_POSIX_H_
#define MINI_CHROMIUM_SRC_CRBASE_LOGGING_LOGGING_INTERNAL_POSIX_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_LOGGING_LOGGING_INTERNAL_POSIX_H_
