...
#ifndef MINI_CHROMIUM_SRC_CRBASE_NUMERICS_CHECKED_MATH_H_
#define MINI_CHROMIUM_SRC_CRBASE_NUMERICS_CHECKED_MATH_H_
...
#include "cr_base/numerics/internal/checked_math_impl.h"
...
class CheckedNumeric {
 ...
 public:
  ...
  // current state is not valid it will CR_CHECK and crash.
  // A range checked destination type can be supplied using the Dst template
  // parameter, which will trigger a CR_CHECK if the value is not in bounds for
  // the destination.
  ...
  // any other state.
  // A range checked destination type can be supplied using the Dst template
  // parameter. WARNING: This function may fail to compile or CR_CHECK at 
  // runtime if the supplied default_value is not within range of the 
  // destination type.
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_NUMERICS_CHECKED_MATH_H_
