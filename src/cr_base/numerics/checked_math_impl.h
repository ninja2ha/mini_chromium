...
#ifndef MINI_CHROMIUM_SRC_CRBASE_NUMERICS_CHECKED_MATH_IMPL_H_
#define MINI_CHROMIUM_SRC_CRBASE_NUMERICS_CHECKED_MATH_IMPL_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_NUMERICS_CHECKED_MATH_IMPL_H_
