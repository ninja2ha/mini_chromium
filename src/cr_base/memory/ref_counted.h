...
#include "cr_base/memory/internal/atomic_ref_count.h"
...
class CRBASE_EXPORT RefCountedBase {
 ...
 private:
  ...
  ///CR_FRIEND_GTEST_ALL_PREFIXES(RefCountedDeathTest, TestOverflowCheck);
...
// regression and is probably not worth it.
 ...
 private:
  ...
  mutable internal::AtomicRefCount ref_count_{0};
#if CR_DCHECK_IS_ON()
  mutable bool needs_adopt_ref_ = false;
  mutable bool in_dtor_ = false;
#endif
...
// to start-from-one ref count. Put CR_REQUIRE_ADOPTION_FOR_REFCOUNTED_TYPE() to
...
//     ~MyFoo();
//
// We can use CR_REQUIRE_ADOPTION_FOR_REFCOUNTED_TYPE() with 
// RefCountedThreadSafe too. 
...
class RefCountedData
 ...
 public:
  ...
  explicit RefCountedData(internal::in_place_t, Args&&... args)
