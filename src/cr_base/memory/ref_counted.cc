...
///#include "cr_base/threading/thread_collision_warner.h"
...
//
// In an attempt to avoid binary bloat (from inlining the `CR_CHECK`), we define
// these functions out-of-line. However, compilers are wily. Further testing may
// show that `CR_NOINLINE` helps or hurts.
//
