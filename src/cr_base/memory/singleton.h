...
// function-local static of type cr::NoDestructor<T> instead:
//
// Factory& Factory::GetInstance() {
//   static cr::NoDestructor<Factory> instance;
//   return *instance;
// }
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//
...
#include "cr_base/memory/internal/lazy_instance_helpers.h"
...
//    private:
//     FooClass() { ... }
//     friend struct cr::DefaultSingletonTraits<FooClass>;
//   };
//
// In your source file:
//  #include "cr_base/memory/singleton.h"
//  FooClass* FooClass::GetInstance() {
//    return cr::Singleton<FooClass>::get();
//  }
//
...
//  FooClass* FooClass::GetInstance() {
//    return cr::Singleton<
//        FooClass, cr::LeakySingletonTraits<FooClass>>::get();
//  }
//
