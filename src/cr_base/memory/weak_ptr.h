...
class CRBASE_EXPORT WeakReference {
 public:
  ...
  // deleted from another via cr::WeakPtr::~WeakPtr().
  ...
  WeakReference();
  explicit WeakReference(const RefPtr<Flag>& flag);
  ~WeakReference();
...
class CRBASE_EXPORT WeakReferenceOwner {
 ...
 private:
  RefPtr<WeakReference::Flag> flag_;
};
...
class SupportsWeakPtrBase {
 public:
  ...
  // from SupportsWeakPtr<Base>. See cr::AsWeakPtr() below for a helper
...
namespace internal {
class CRBASE_EXPORT WeakPtrFactoryBase {
 protected:
...
//
// EXAMPLE:
//   class Base : public cr::SupportsWeakPtr<Producer> {};
//   class Derived : public Base {};
//
//   Derived derived;
//   cr::WeakPtr<Derived> ptr = cr::AsWeakPtr(&derived);
//
...
// the caller.
//
//   cr::WeakPtr<Derived> ptr = derived.AsWeakPtr();  // Fails.
