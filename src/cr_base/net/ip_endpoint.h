...
#ifndef MINI_CHROMIUM_SRC_CRBASE_NET_IP_ENDPOINT_H_
#define MINI_CHROMIUM_SRC_CRBASE_NET_IP_ENDPOINT_H_
...
//  * Port
class CRBASE_EXPORT IPEndPoint {
 public:
  IPEndPoint();
  ~IPEndPoint();
  ...
  bool FromSockAddr(const struct sockaddr* address,
                    size_t address_length) CR_WARN_UNUSED_RESULT;
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_NET_IP_ENDPOINT_H_
