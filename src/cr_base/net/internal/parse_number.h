...
#ifndef MINI_CHROMIUM_SRC_CRBASE_NET_INTERNAL_PARSE_NUMBER_H_
#define MINI_CHROMIUM_SRC_CRBASE_NET_INTERNAL_PARSE_NUMBER_H_
...
// failure.
CRBASE_EXPORT bool ParseInt32(
    StringPiece input,
    ParseIntFormat format,
    int32_t* output,
    ParseIntError* optional_error = nullptr) CR_WARN_UNUSED_RESULT;

CRBASE_EXPORT bool ParseInt64(
    StringPiece input,
    ParseIntFormat format,
    int64_t* output,
    ParseIntError* optional_error = nullptr) CR_WARN_UNUSED_RESULT;
...
CRBASE_EXPORT bool ParseUint32(
    StringPiece input,
    ParseIntFormat format,
    uint32_t* output,
    ParseIntError* optional_error = nullptr) CR_WARN_UNUSED_RESULT;

CRBASE_EXPORT bool ParseUint64(
    StringPiece input,
    ParseIntFormat format,
    uint64_t* output,
    ParseIntError* optional_error = nullptr) CR_WARN_UNUSED_RESULT;
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_NET_INTERNAL_PARSE_NUMBER_H_