...
#ifndef MINI_CHROMIUM_SRC_CRBASE_COM_WIN_SCOPED_COMPTR_H_
#define MINI_CHROMIUM_SRC_CRBASE_COM_WIN_SCOPED_COMPTR_H_

#include "cr_base/logging/logging.h"
#include "cr_base/memory/ref_counted.h"
#include "cr_base/win/windows_full.h"
...
// Uses cr::RefPtr for the basic smart pointer functionality
// and adds a few IUnknown specific services.
template <class Interface, const IID* interface_id>
class ScopedComPtr : public cr::RefPtr<Interface> {
 public:
  ...
  typedef cr::RefPtr<Interface> ParentClass;
  ...
  //    CR_SCOPED_COMPTR(IUnknown) p(Foo());
  //    p->Release();
  ...
  using RefPtr<Interface>::operator=;
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_COM_WIN_SCOPED_COMPTR_H_