...
#ifndef MINI_CHROMIUM_SRC_CRBASE_WIN_COM_SCOPED_VARIANT_H_
#define MINI_CHROMIUM_SRC_CRBASE_WIN_COM_SCOPED_VARIANT_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_WIN_COM_SCOPED_VARIANT_H_