...
#ifndef MINI_CHROMIUM_SRC_CRBASE_DATA_STREAM_INTERNAL_BUFFER_H_
#define MINI_CHROMIUM_SRC_CRBASE_DATA_STREAM_INTERNAL_BUFFER_H_
...
class BufferT {
 ...
 public:
  ...
  template <typename W,
            typename std::enable_if<
                internal::has_data_and_size<
                    const W, const T>::value>::type* = nullptr>
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_DATA_STREAM_INTERNAL_BUFFER_H_