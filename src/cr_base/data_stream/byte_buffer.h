...
#ifndef MINI_CHROMIUM_SRC_CRBASE_DATA_STREAM_BYTE_BUFFER_H_
#define MINI_CHROMIUM_SRC_CRBASE_DATA_STREAM_BYTE_BUFFER_H_
...
#include "cr_base/data_stream/internal/buffer.h"

namespace cr {

class CRBASE_EXPORT ByteBuffer {
 public:
  enum ByteOrder {
...
class CRBASE_EXPORT ByteBufferWriter : public ByteBuffer {
 public:
  ByteBufferWriter(const ByteBufferWriter&) = delete;
  ByteBufferWriter& operator=(const ByteBufferWriter&) = delete;

  explicit ByteBufferWriter(ByteOrder byte_order) : ByteBuffer(byte_order) {
...
class CRBASE_EXPORT ByteBufferReader : public ByteBuffer {
 public:
...
class NetByteBufferWriter : public ByteBufferWriter {
 public:
  NetByteBufferWriter(const NetByteBufferWriter&) = delete;
  NetByteBufferWriter& operator=(const NetByteBufferWriter&) = delete;
...
class NetByteBufferReader : public ByteBufferReader {
public:
...
class HostByteBufferWriter : public ByteBufferWriter {
 public:
  HostByteBufferWriter(const HostByteBufferWriter&) = delete;
  HostByteBufferWriter& operator=(const HostByteBufferWriter&) = delete;
...
class HostByteBufferReader : public ByteBufferReader {
public:
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_DATA_STREAM_BYTE_BUFFER_H_