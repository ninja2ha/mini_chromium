...
#ifndef MINI_CHROMIUM_SRC_CRBASE_CONTAINERS_CONTIGUOUS_ITERATOR_H_
#define MINI_CHROMIUM_SRC_CRBASE_CONTAINERS_CONTIGUOUS_ITERATOR_H_
...
template <typename T>
struct PointsToObject : std::is_object<cr::internal::iter_value_t<T>> {};
...
template <typename T, 
          typename StringT = std::basic_string<cr::internal::iter_value_t<T>>>
struct IsStringIterImpl
    : cr::internal::disjunction<
          std::is_same<T, typename StringT::const_iterator>,
...
template <typename T>
struct IsStringIter
    : cr::internal::conjunction<
          std::is_trivial<cr::internal::iter_value_t<T>>,
                          IsStringIterImpl<T>> {};
...
struct IsArrayIter
    : cr::internal::disjunction<
          std::is_same<T, typename ArrayT::const_iterator>,
...
struct IsVectorIter
    : cr::internal::conjunction<
          cr::internal::negation<
              std::is_same<cr::internal::iter_value_t<T>, bool>>,
          cr::internal::disjunction<
              std::is_same<T, typename VectorT::const_iterator>,
...
struct IsCheckedContiguousIter
    : cr::internal::disjunction<
          std::is_same<T, CheckedContiguousConstIterator<ValueT>>,
...
struct IsContiguousIteratorImpl
    : cr::internal::conjunction<PointsToObject<T>,
      cr::internal::disjunction<IsPointer<T>,
      IsStringIter<T>,
      IsArrayIter<T>,
      IsVectorIter<T>,
      IsValueArrayIter<T>,
...
struct IsContiguousIterator
    : cr::internal::IsContiguousIteratorImpl<cr::internal::remove_cvref_t<T>> {
};

}  // namespace internal
}  // namespace cr

#endif  // MINI_CHROMIUM_SRC_CRBASE_CONTAINERS_CONTIGUOUS_ITERATOR_H_