...
//     cr::BindOnce(&TimeoutCallback, "Test timed out."));
// ThreadTaskRunnerHandle::Get()->PostDelayedTask(
//     CR_FROM_HERE, timeout.callback(), TimeDelta::FromSeconds(4));
// RunIntensiveTest();
// run_loop.Run();
// timeout.Cancel();  // Hopefully this is hit before the timeout callback runs.
//

#ifndef MINI_CHROMIUM_SRC_CRBASE_CANCELABLE_CALLBACK_H_
#define MINI_CHROMIUM_SRC_CRBASE_CANCELABLE_CALLBACK_H_
...
class CancelableCallbackImpl {
 ...
 private:
  ...
  mutable cr::WeakPtrFactory<CancelableCallbackImpl> weak_ptr_factory_{this};
};

}  // namespace internal

// Consider using cr::WeakPtr directly instead of cr::CancelableCallback for
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_CANCELABLE_CALLBACK_H_