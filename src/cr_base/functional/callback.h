...
// cr::{Once,Repeating}Callback or cr::{Once,Repeating}Closure should
// #include "cr_base/functional/callback_forward.h" instead of this file.
...
#include "cr_base/functional/callback_forward.h"
...
//
// Unlike function pointers, callbacks are created with cr::BindOnce() or
// cr::BindRepeating() and support partial function application.
//
// A cr::OnceCallback may be Run() at most once; a cr::RepeatingCallback may
// be Run() any number of times. |is_null()| is guaranteed to return true for a
// moved-from callback.
//
//   // The lambda takes two arguments, but the first argument |x| is bound at
//   // callback creation.
//   cr::OnceCallback<int(int)> cb = cr::BindOnce([] (int x, int y) {
//     return x + y;
//   }, 1);
...
//
// cr::Callback is currently a type alias for cr::RepeatingCallback. In the
// future, we expect to flip this to default to cr::OnceCallback.
//
