...
#include "cr_base/json/internal/json_common.h"
...
class CRBASE_EXPORT JSONParser {
 public:
  ...
  enum JsonParseError {
    JSON_NO_ERROR = cr::ValueDeserializer::kErrorCodeNoError,
    JSON_SYNTAX_ERROR = cr::ValueDeserializer::kErrorCodeInvalidFormat,
    JSON_INVALID_ESCAPE,
...
CRBASE_EXPORT extern const char kUnicodeReplacementString[];

}  // namespace internal
}  // namespace cr

#endif  // MINI_CHROMIUM_SRC_CRBASE_JSON_INTERNAL_JSON_PARSER_H_