...
CRBASE_EXPORT bool EscapeJSONString(StringPiece str,
                                    bool put_in_quotes,
                                    std::string* dest);
...
CRBASE_EXPORT bool EscapeJSONString(StringPiece16 str,
                                    bool put_in_quotes,
                                    std::string* dest);

// Helper functions that wrap the above two functions but return the value
// instead of appending. |put_in_quotes| is always true.
CRBASE_EXPORT std::string GetQuotedJSONString(StringPiece str);
CRBASE_EXPORT std::string GetQuotedJSONString(StringPiece16 str);
...
CRBASE_EXPORT std::string EscapeBytesAsInvalidJSONString(StringPiece str,
                                                         bool put_in_quotes);
