...
#ifndef MINI_CHROMIUM_SRC_CRBASE_INTERNAL_OBSERVER_LIST_INTERNAL_H_
#define MINI_CHROMIUM_SRC_CRBASE_INTERNAL_OBSERVER_LIST_INTERNAL_H_

#include "cr_base/base_export.h"
#include "cr_base/logging/logging.h"
#include "cr_base/containers/linked_list.h"
#include "cr_base/memory/weak_ptr.h"
#include "cr_base/observer_list_types.h"
...
class CRBASE_EXPORT UncheckedObserverAdapter {
 public:
...
class CRBASE_EXPORT CheckedObserverAdapter {
 public:
  ...
  bool IsMarkedForRemoval() const {
    ...
    CR_CHECK(!weak_ptr_.WasInvalidated());
...
class WeakLinkNode : public cr::LinkNode<WeakLinkNode<ObserverList>> {
 public:
  ...
  ObserverList* get() const {
    if (list_)
      CR_DCHECK_CALLED_ON_VALID_SEQUENCE(list_->iteration_sequence_checker_);
    return list_;
  }
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_INTERNAL_OBSERVER_LIST_INTERNAL_H_