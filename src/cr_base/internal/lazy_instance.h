...
#ifndef MINI_CHROMIUM_SRC_CRBASE_INTERNAL_LAZY_INSTANCE_H_
#define MINI_CHROMIUM_SRC_CRBASE_INTERNAL_LAZY_INSTANCE_H_
...
#include "cr_base/internal/lazy_instance_helpers.h"
///#include "base/threading/thread_restrictions.h"

// LazyInstance uses its own struct initializer-list style static
// initialization, which does not require a constructor.
#define CR_LAZY_INSTANCE_INITIALIZER {}
...
struct LazyInstanceTraitsBase {
  static Type* New(void* instance) {
    CR_DCHECK(
        (reinterpret_cast<uintptr_t>(instance) & (alignof(Type) - 1)) == 0u);
...
struct LeakyLazyInstanceTraits {
  ...
  static Type* New(void* instance) {
    ...
    CR_DVLOG(1) << "LeakyLazyInstanceTraits::New Leak.";
    return LazyInstanceTraitsBase<Type>::New(instance);
  }
  static void Delete(Type* instance) {
  }
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_INTERNAL_LAZY_INSTANCE_H_