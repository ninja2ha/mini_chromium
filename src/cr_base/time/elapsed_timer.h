...
#ifndef MINI_CHROMIUM_SRC_CRBASE_TIME_ELAPSED_TIMER_H_
#define MINI_CHROMIUM_SRC_CRBASE_TIME_ELAPSED_TIMER_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_TIME_ELAPSED_TIMER_H_