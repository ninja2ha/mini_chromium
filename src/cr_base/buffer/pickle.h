...
class CRBASE_EXPORT PickleIterator {
 public:
  ...
  bool ReadString16(std::u16string* result) CR_WARN_UNUSED_RESULT;
  ...
  bool ReadData(Span<const uint8_t>* data) CR_WARN_UNUSED_RESULT;
 ...
 private:
  ...
  CR_FRIEND_GTEST_ALL_PREFIXES(PickleTest, GetReadPointerAndAdvance);
};
...
class CRBASE_EXPORT Pickle {
 public:
  ...
  // attachments.
  class CRBASE_EXPORT Attachment : public RefCountedThreadSafe<Attachment> {
   public:
    Attachment();
  ...
  // attachments.
  virtual bool WriteAttachment(RefPtr<Attachment> attachment);
  ...
  virtual bool ReadAttachment(PickleIterator* iter,
                              RefPtr<Attachment>* attachment) const;
  ...
  template <class T>
  T* headerT() {
    CR_DCHECK(header_size_ == sizeof(T));
 ...
 private:
  ...
  CR_FRIEND_GTEST_ALL_PREFIXES(PickleTest, DeepCopyResize);
  CR_FRIEND_GTEST_ALL_PREFIXES(PickleTest, Resize);
  CR_FRIEND_GTEST_ALL_PREFIXES(PickleTest, PeekNext);
  CR_FRIEND_GTEST_ALL_PREFIXES(PickleTest, PeekNextOverflow);
  CR_FRIEND_GTEST_ALL_PREFIXES(PickleTest, FindNext);
  CR_FRIEND_GTEST_ALL_PREFIXES(PickleTest, FindNextWithIncompleteHeader);
  CR_FRIEND_GTEST_ALL_PREFIXES(PickleTest, FindNextOverflow);
};
