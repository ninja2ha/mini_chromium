...
#ifndef MINI_CHROMIUM_SRC_CRBASE_TOKEN_UNGUESSABLE_TOKEN_H_
#define MINI_CHROMIUM_SRC_CRBASE_TOKEN_UNGUESSABLE_TOKEN_H_
...
///#include "cr_base/hash/hash.h"
#include "cr_base/token/token.h"
...
// cr::Optional instead of an empty token.

class CRBASE_EXPORT UnguessableToken {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_TOKEN_UNGUESSABLE_TOKEN_H_
