...
#ifndef MINI_CHROMIUM_SRC_CRNET_SOCKET_UDP_UDP_SOCKET_GLOBAL_LIMITS_H_
#define MINI_CHROMIUM_SRC_CRNET_SOCKET_UDP_UDP_SOCKET_GLOBAL_LIMITS_H_
...
class CRNET_EXPORT OwnedUDPSocketCount {
 public:
 ...
 private:
  ...
  // OwnedUDPSocketCount.
  friend CRNET_EXPORT OwnedUDPSocketCount TryAcquireGlobalUDPSocketCount();
...
CRNET_EXPORT OwnedUDPSocketCount TryAcquireGlobalUDPSocketCount()
    CR_WARN_UNUSED_RESULT;

}  // namespace crnet

#endif  // MINI_CHROMIUM_SRC_CRNET_SOCKET_UDP_UDP_SOCKET_GLOBAL_LIMITS_H_