...
///#include "cr_base/power_monitor/power_observer.h"
...
class CRNET_EXPORT TCPClientSocket : public TransportClientSocket/*,
                                     public cr::PowerSuspendObserver*/ {
 public:
  ...
  // cr::PowerSuspendObserver methods:
 ...
 private:
  ...
  // cr::TimeDelta::Max().
  cr::TimeDelta GetConnectAttemptTimeout();
  ...
  cr::Optional<cr::TimeTicks> start_connect_attempt_;

  // The NetworkQualityEstimator for the context this socket is associated with.
  // Can be nullptr.
  ///NetworkQualityEstimator* network_quality_estimator_;

  cr::OneShotTimer connect_attempt_timer_;
