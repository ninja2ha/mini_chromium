...
#ifndef MINI_CHROMIUM_SRC_CRNET_SOCKET_SOCKET_OPTIONS_H_
#define MINI_CHROMIUM_SRC_CRNET_SOCKET_SOCKET_OPTIONS_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_SOCKET_SOCKET_OPTIONS_H_