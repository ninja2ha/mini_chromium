...
#ifndef MINI_CHROMIUM_SRC_CRNET_DNS_SYSTEM_DNS_CONFIG_CHANGE_NOTIFIER_H_
#define MINI_CHROMIUM_SRC_CRNET_DNS_SYSTEM_DNS_CONFIG_CHANGE_NOTIFIER_H_
...
class CRNET_EXPORT SystemDnsConfigChangeNotifier {
 public:
  class Observer {
   public:
    ...
    virtual void OnSystemDnsConfigChanged(cr::Optional<DnsConfig> config) = 0;
  };
 ...
 private:
  ...
  std::unique_ptr<Core, cr::OnTaskRunnerDeleter> core_;
};

}  // namespace net
}  // namespace cr

#endif  // MINI_CHROMIUM_SRC_CRNET_DNS_SYSTEM_DNS_CONFIG_CHANGE_NOTIFIER_H_
