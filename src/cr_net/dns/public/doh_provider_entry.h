...
#ifndef MINI_CHROMIUM_SRC_CRNET_DNS_PUBLIC_DOH_PROVIDER_ENTRY_H_
#define MINI_CHROMIUM_SRC_CRNET_DNS_PUBLIC_DOH_PROVIDER_ENTRY_H_
...
// dropdown menu.
struct CRNET_EXPORT DohProviderEntry {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CRNET_DNS_PUBLIC_DOH_PROVIDER_ENTRY_H_