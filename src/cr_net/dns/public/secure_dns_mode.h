...
#ifndef MINI_CHROMIUM_SRC_CRNET_DNS_PUBLIC_SECURE_DNS_MODE_H_
#define MINI_CHROMIUM_SRC_CRNET_DNS_PUBLIC_SECURE_DNS_MODE_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_DNS_PUBLIC_SECURE_DNS_MODE_H_