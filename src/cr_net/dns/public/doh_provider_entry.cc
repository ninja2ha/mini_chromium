...
std::set<IPAddress> ParseIPs(const std::set<cr::StringPiece>& ip_strs) {
  std::set<IPAddress> ip_addresses;
  for (cr::StringPiece ip_str : ip_strs) {
...
const DohProviderEntry::List& DohProviderEntry::GetList() {
  ...
  static const cr::NoDestructor<DohProviderEntry::List> providers{{
      ...
      new DohProviderEntry(
          "CleanBrowsingAdult", cr::nullopt /* provider_id_for_histogram */,
      ...
      new DohProviderEntry(
          ...
          LoggingLevel::kNormal),
      new DohProviderEntry(
          "CleanBrowsingSecure", cr::nullopt /* provider_id_for_histogram */,
      ...
      new DohProviderEntry(
          ...
          LoggingLevel::kExtra),
      new DohProviderEntry(
          "Comcast", cr::nullopt /* provider_id_for_histogram */,
      ...
      new DohProviderEntry(
          "Dnssb", cr::nullopt /* provider_id_for_histogram */,
      ...
      new DohProviderEntry("Google", DohProviderIdForHistogram::kGoogle,
                           ...
                           {} /* display_countries */, LoggingLevel::kExtra),
      new DohProviderEntry(
          "GoogleDns64", cr::nullopt /* provider_id_for_histogram */,
      ...
      new DohProviderEntry("OpenDNS", DohProviderIdForHistogram::kOpenDns,
                           ...
                           {} /* display_countries */, LoggingLevel::kNormal),
      new DohProviderEntry(
          "OpenDNSFamily", cr::nullopt /* provider_id_for_histogram */,
          ...
          LoggingLevel::kNormal),
      new DohProviderEntry(
          "Quad9Cdn", cr::nullopt /* provider_id_for_histogram */,
          ...
          {} /* display_countries */, LoggingLevel::kNormal),
      new DohProviderEntry(
          "Quad9Insecure", cr::nullopt /* provider_id_for_histogram */,
      ...
      new DohProviderEntry(
          ...
          LoggingLevel::kExtra),
      new DohProviderEntry(
          "Quickline", cr::nullopt /* provider_id_for_histogram */,
          ...
          {} /* display_countries */, LoggingLevel::kNormal),
      new DohProviderEntry(
          "Spectrum1", cr::nullopt /* provider_id_for_histogram */,
          ...
          {} /* display_countries */, LoggingLevel::kNormal),
      new DohProviderEntry(
          "Spectrum2", cr::nullopt /* provider_id_for_histogram */,
          {"209.18.47.61", "209.18.47.62", "2001:1998:0f00:0001::1",
           "2001:1998:0f00:0002::1"},
          {""} /* dns_over_tls_hostnames */,
          ...
          {} /* display_countries */, LoggingLevel::kNormal),
      new DohProviderEntry(
          "Switch", cr::nullopt /* provider_id_for_histogram */,
...
DohProviderEntry DohProviderEntry::ConstructForTesting(
    std::string provider,
    cr::Optional<DohProviderIdForHistogram> provider_id_for_histogram,
    std::set<cr::StringPiece> ip_strs,
...
DohProviderEntry::DohProviderEntry(
  ...
  CR_DCHECK(!this->dns_over_https_template.empty());
  CR_DCHECK(dns_util::IsValidDohTemplate(this->dns_over_https_template,
                                         nullptr /* server_method */));

  CR_DCHECK(!display_globally || this->display_countries.empty());
  if (display_globally || !this->display_countries.empty()) {
    CR_DCHECK(!this->ui_name.empty());
    CR_DCHECK(!this->privacy_policy.empty());
    CR_DCHECK(this->provider_id_for_histogram.has_value());
  }
  for (const auto& display_country : this->display_countries) {
    CR_DCHECK(2u == display_country.size());
  }
}
