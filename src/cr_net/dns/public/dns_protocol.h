...
#ifndef MINI_CHROMIUM_SRC_CRNET_DNS_PUBLIC_DNS_PROTOCOL_H_
#define MINI_CHROMIUM_SRC_CRNET_DNS_PUBLIC_DNS_PROTOCOL_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_DNS_PUBLIC_DNS_PROTOCOL_H_