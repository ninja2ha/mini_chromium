...
#ifndef MINI_CHROMIUM_SRC_CRNET_DNS_DNS_CONFIG_H_
#define MINI_CHROMIUM_SRC_CRNET_DNS_DNS_CONFIG_H_
...
constexpr cr::TimeDelta kDnsDefaultFallbackPeriod =
    cr::TimeDelta::FromSeconds(1);

// DnsConfig stores configuration of the system resolver.
struct CRNET_EXPORT DnsConfig {
  DnsConfig();
...
#endif  // MINI_CHROMIUM_SRC_CRNET_DNS_DNS_CONFIG_H_