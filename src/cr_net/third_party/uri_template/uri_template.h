...
#ifndef MINI_CHROMIUM_SRC_CRNET_THIRD_PARTY_URI_TEMPLATE_URI_TEMPLATE_H_
#define MINI_CHROMIUM_SRC_CRNET_THIRD_PARTY_URI_TEMPLATE_URI_TEMPLATE_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_THIRD_PARTY_URI_TEMPLATE_URI_TEMPLATE_H_