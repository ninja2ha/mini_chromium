...
#ifndef MINI_CHROMIUM_SRC_CRNET_BASE_WIN_WINSOCK_INIT_H_
#define MINI_CHROMIUM_SRC_CRNET_BASE_WIN_WINSOCK_INIT_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_BASE_WIN_WINSOCK_INIT_H_