...
#ifndef MINI_CHROMIUM_SRC_CRNET_BASE_WIN_WINSOCK_UTIL_H_
#define MINI_CHROMIUM_SRC_CRNET_BASE_WIN_WINSOCK_UTIL_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_BASE_WIN_WINSOCK_UTIL_H_