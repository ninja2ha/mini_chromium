...
#ifndef MINI_CHROMIUM_SRC_CRNET_BASE_DATAGRAM_BUFFER_H_
#define MINI_CHROMIUM_SRC_CRNET_BASE_DATAGRAM_BUFFER_H_
...
class CRNET_EXPORT DatagramBufferPool {
 public:
...
class CRNET_EXPORT DatagramBuffer {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CRNET_BASE_DATAGRAM_BUFFER_H_