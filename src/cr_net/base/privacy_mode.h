...
#ifndef MINI_CHROMIUM_SRC_CRNET_BASE_PRIVACY_MODE_H_
#define MINI_CHROMIUM_SRC_CRNET_BASE_PRIVACY_MODE_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_BASE_PRIVACY_MODE_H_
