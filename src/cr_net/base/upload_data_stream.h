...
#ifndef MINI_CHROMIUM_SRC_CRNET_BASE_UPLOAD_DATA_STREAM_H_
#define MINI_CHROMIUM_SRC_CRNET_BASE_UPLOAD_DATA_STREAM_H_
...
class CRNET_EXPORT UploadDataStream {
 public:
 ...
 private:
  ...
  virtual int ReadInternal(cr::IOBuffer* buf, int buf_len) = 0;
...
#endif  // MINI_CHROMIUM_SRC_CRNET_BASE_UPLOAD_DATA_STREAM_H_
