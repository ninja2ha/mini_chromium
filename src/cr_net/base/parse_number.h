...
#ifndef MINI_CHROMIUM_SRC_CRNET_BASE_PARSE_NUMBER_H_
#define MINI_CHROMIUM_SRC_CRNET_BASE_PARSE_NUMBER_H_
...
// failure.
CRNET_EXPORT bool ParseInt32(const cr::StringPiece& input,
                             ParseIntFormat format,
                             int32_t* output,
                             ParseIntError* optional_error = nullptr)
    CR_WARN_UNUSED_RESULT;

CRNET_EXPORT bool ParseInt64(const cr::StringPiece& input,
                             ParseIntFormat format,
                             int64_t* output,
                             ParseIntError* optional_error = nullptr)
    CR_WARN_UNUSED_RESULT;
...
CRNET_EXPORT bool ParseUint32(const cr::StringPiece& input,
                              uint32_t* output,
                              ParseIntError* optional_error = nullptr)
    CR_WARN_UNUSED_RESULT;

CRNET_EXPORT bool ParseUint64(const cr::StringPiece& input,
                              uint64_t* output,
                              ParseIntError* optional_error = nullptr)
    CR_WARN_UNUSED_RESULT;
