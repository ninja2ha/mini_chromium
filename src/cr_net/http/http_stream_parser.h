...
#ifndef MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_STREAM_PARSER_H_
#define MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_STREAM_PARSER_H_
...
///#include "cr_crypto/ec_private_key.h"
#include "cr_net/base/completion_once_callback.h"
#include "cr_net/base/completion_repeating_callback.h"
...
class CRNET_EXPORT HttpStreamParser {
 public:
  ...
  int ReadResponseBody(cr::IOBuffer* buf,
                       int buf_len,
                       CompletionOnceCallback callback);
  ...
  cr::TimeTicks first_response_start_time() const {
    return first_response_start_time_;
  }
  cr::TimeTicks non_informational_response_start_time() const {
    return non_informational_response_start_time_;
  }
  cr::TimeTicks first_early_hints_time() { return first_early_hints_time_; }
  ...
  static int EncodeChunk(const cr::StringPiece& payload,
                         char* output,
                         size_t output_size);
 ...
 private:
  ...
  cr::RefPtr<cr::DrainableIOBuffer> request_headers_;
  ...
  cr::RefPtr<cr::GrowableIOBuffer> read_buf_;
  ...
  cr::TimeTicks first_response_start_time_;
  ...
  cr::TimeTicks current_response_start_time_;
  ...
  cr::RefPtr<cr::IOBuffer> user_read_buf_;
  ...
  cr::WeakPtrFactory<HttpStreamParser> weak_ptr_factory_{this};
};

}  // namespace crnet

#endif  // MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_STREAM_PARSER_H_
