...
#ifndef MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_RESPONSE_INFO_H_
#define MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_RESPONSE_INFO_H_
...
///#include "cr_net/base/auth.h"
#include "cr_net/base/ip_endpoint.h"
#include "cr_net/net_export.h"
///#include "cr_net/base/proxy_server.h"
///#include "cr_net/dns/public/resolve_error_info.h"
///#include "cr_net/http/http_vary_data.h"
...
class CRNET_EXPORT HttpResponseInfo {
 public:
  ...
  enum ConnectionInfo {
    ...
    CONNECTION_INFO_HTTP0_9 = 1,
    CONNECTION_INFO_HTTP1_0 = 2,
    CONNECTION_INFO_HTTP1_1 = 3,
  ...
  cr::Time stale_revalidate_timeout;
  ...
  ///cr::Optional<AuthChallengeInfo> auth_challenge;
  ...
  ///cr::RefPtr<SSLCertRequestInfo> cert_request_info;
...
#endif  // MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_RESPONSE_INFO_H_