...
#ifndef MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_CHUNKED_DECODER_H_
#define MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_CHUNKED_DECODER_H_
...
// not used on the web.
//
class CRNET_EXPORT HttpChunkedDecoder {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_CHUNKED_DECODER_H_
