...
#ifndef MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_BYTE_RANGE_H_
#define MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_BYTE_RANGE_H_
...
class CRNET_EXPORT HttpByteRange {
 public:
  HttpByteRange();
...
#endif  // MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_BYTE_RANGE_H_