...
#ifndef MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_UTIL_H_
#define MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_UTIL_H_
...
class CRNET_EXPORT HttpUtil {
 public:
  ...
  static std::string SpecForRequest(const crurl::GURL& url);
  ...
  // RFC 7231).
  static bool IsMethodSafe(cr::StringPiece method);

  // Returns true if the request method is idempotent (per section 4.2.2 of
  // RFC 7231).
  static bool IsMethodIdempotent(cr::StringPiece method);
  ...
  // validity.
  static bool IsSafeHeader(cr::StringPiece name);

  // Returns true if |name| is a valid HTTP header name.
  static bool IsValidHeaderName(cr::StringPiece name);
  ...
  static bool IsValidHeaderValue(cr::StringPiece value);
  ...
  static bool IsNonCoalescingHeader(cr::StringPiece name);
  ...
  static cr::StringPiece TrimLWS(const cr::StringPiece& string);
  ...
  static bool IsToken(cr::StringPiece str);
  ...
  static bool IsParmName(cr::StringPiece str);
  ...
  static std::string Unquote(cr::StringPiece str);
  ...
  static bool StrictUnquote(cr::StringPiece str,
                            std::string* out) CR_WARN_UNUSED_RESULT;

  // The reverse of Unquote() -- escapes and surrounds with "
  static std::string Quote(cr::StringPiece str);
  ...
  //                         HttpResponseHeaders.
  static std::string AssembleRawHeaders(cr::StringPiece buf);
  ...
  // does not expect any).
  class CRNET_EXPORT HeadersIterator {
   public:
    ...
    cr::StringPiece name_piece() const {
      return cr::MakeStringPiece(name_begin_, name_end_);
    }
    ...
    cr::StringPiece values_piece() const {
      return cr::MakeStringPiece(values_begin_, values_end_);
    }

   private:
    cr::StringTokenizer lines_;
  ...
  // quoted string.
  class CRNET_EXPORT ValuesIterator {
   public:
    ...
    cr::StringPiece value_piece() const {
      return cr::MakeStringPiece(value_begin_, value_end_);
    }

   private:
    cr::StringTokenizer values_;
  ...
  class CRNET_EXPORT NameValuePairsIterator {
   public:
...
#endif  // MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_UTIL_H_