...
#ifndef MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_REQUEST_INFO_H_
#define MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_REQUEST_INFO_H_

#include <string>

#include "cr_base/containers/optional.h"
#include "cr_net/net_export.h"
#include "cr_net/base/idempotency.h"
#include "cr_net/base/privacy_mode.h"
...
struct CRNET_EXPORT HttpRequestInfo {
  HttpRequestInfo();
  ...
  cr::Optional<crurl::Origin> possibly_top_frame_origin;
  ...
  crnet::Idempotency idempotency;
};

}  // namespace crnet

#endif  // MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_REQUEST_INFO_H_
