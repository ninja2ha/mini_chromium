...
#ifndef MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_TRANSACTION_H_
#define MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_TRANSACTION_H_

#include <stdint.h>

#include "cr_net/base/completion_once_callback.h"
#include "cr_net/base/completion_repeating_callback.h"
#include "cr_net/base/load_states.h"
#include "cr_net/base/net_error_details.h"
#include "cr_net/net_export.h"
#include "cr_net/base/request_priority.h"
#include "cr_net/base/upload_progress.h"
#include "cr_net/http/http_raw_request_headers.h"
#include "cr_net/http/http_response_headers.h"
#include "cr_net/socket/connection_attempts.h"
///#include "cr_net/websockets/websocket_handshake_stream_base.h"
...
class CRNET_EXPORT HttpTransaction {
 public:
  ...
  using ConnectedCallback =
      cr::RepeatingCallback<int(const TransportInfo& info,
  ...
  ///    cr::RefPtr<X509Certificate> client_cert,
  ///    cr::RefPtr<SSLPrivateKey> client_private_key,
  ...
  //
  virtual int Read(cr::IOBuffer* buf,
                   int buf_len,
                   CompletionOnceCallback callback) = 0;
...
#endif  // MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_TRANSACTION_H_
