...
#ifndef MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_VERSION_H_
#define MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_VERSION_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_HTTP_HTTP_VERSION_H_