...
#ifndef MINI_CHROMIUM_SRC_CRNET_NETWORK_NETWORK_ACTIVITY_MONITOR_H_
#define MINI_CHROMIUM_SRC_CRNET_NETWORK_NETWORK_ACTIVITY_MONITOR_H_
...
class CRNET_EXPORT NetworkActivityMonitor {
 public:
 ...
 private:
  ///friend class test::NetworkActivityMonitorPeer;
   friend struct cr::DefaultSingletonTraits<NetworkActivityMonitor>;
...
#endif  // MINI_CHROMIUM_SRC_CRNET_NETWORK_NETWORK_ACTIVITY_MONITOR_H_