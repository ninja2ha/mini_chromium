...
#ifndef MINI_CHROMIUM_SRC_CRNET_NETWORK_NETWORK_CHANGE_NOTIFIER_H_
#define MINI_CHROMIUM_SRC_CRNET_NETWORK_NETWORK_CHANGE_NOTIFIER_H_
...
class CRNET_EXPORT NetworkChangeNotifier {
 public:
  ...
  ///class CRNET_EXPORT DNSObserver {
  /// public:
  ...
  ///  cr::RefPtr<cr::ObserverListThreadSafe<DNSObserver>> observer_list_;
  ///};

  class CRNET_EXPORT NetworkChangeObserver {
   public:
   ...
   private:
    friend NetworkChangeNotifier;
    cr::RefPtr<cr::ObserverListThreadSafe<NetworkChangeObserver>>
        observer_list_;
  };

  class CRNET_EXPORT MaxBandwidthObserver {
   public:
   ...
   private:
    friend NetworkChangeNotifier;
    cr::RefPtr<cr::ObserverListThreadSafe<MaxBandwidthObserver>>
        observer_list_;
  };
  
  class CRNET_EXPORT ConnectionCostObserver {
   public:
   ...
   private:
    friend NetworkChangeNotifier;
    cr::RefPtr<cr::ObserverListThreadSafe<ConnectionCostObserver>>
        observer_list_;
  };
  ...
  // unimplemented.
  class CRNET_EXPORT NetworkObserver {
   public:
   ...
   private:
    friend NetworkChangeNotifier;
    cr::RefPtr<cr::ObserverListThreadSafe<NetworkObserver>> observer_list_;
  };
  ...
  ///class CRNET_EXPORT DisableForTest {
  /// public:
  ///  DisableForTest();
  ///  ~DisableForTest();
  ///
 ...
 protected:
  ...
  // produced.
  struct CRNET_EXPORT NetworkChangeCalculatorParams {
    NetworkChangeCalculatorParams();
    // Controls delay after OnIPAddressChanged when transitioning from an
    // offline state.
    cr::TimeDelta ip_address_offline_delay_;
    // Controls delay after OnIPAddressChanged when transitioning from an
    // online state.
    cr::TimeDelta ip_address_online_delay_;
    // Controls delay after OnConnectionTypeChanged when transitioning from an
    // offline state.
    cr::TimeDelta connection_type_offline_delay_;
    // Controls delay after OnConnectionTypeChanged when transitioning from an
    // online state.
    cr::TimeDelta connection_type_online_delay_;
  };
 ...
 private:
  ...
  ///const cr::RefPtr<base::ObserverListThreadSafe<IPAddressObserver>>
  ///    ip_address_observer_list_;
  ///const cr::RefPtr<base::ObserverListThreadSafe<ConnectionTypeObserver>>
  ///    connection_type_observer_list_;
  ///const cr::RefPtr<cr::ObserverListThreadSafe<DNSObserver>>
  ///    resolver_state_observer_list_;
  const cr::RefPtr<cr::ObserverListThreadSafe<NetworkChangeObserver>>
      network_change_observer_list_;
  const cr::RefPtr<cr::ObserverListThreadSafe<MaxBandwidthObserver>>
      max_bandwidth_observer_list_;
  const cr::RefPtr<cr::ObserverListThreadSafe<NetworkObserver>>
      network_observer_list_;
  const cr::RefPtr<cr::ObserverListThreadSafe<ConnectionCostObserver>>
...
#endif  // MINI_CHROMIUM_SRC_CRNET_NETWORK_NETWORK_CHANGE_NOTIFIER_H_