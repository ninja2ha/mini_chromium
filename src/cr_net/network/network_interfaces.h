...
#ifndef MINI_CHROMIUM_SRC_CRNET_NETWORK_NETWORK_INTERFACES_H_
#define MINI_CHROMIUM_SRC_CRNET_NETWORK_NETWORK_INTERFACES_H_
...
// interface.
struct CRNET_EXPORT NetworkInterface {
  NetworkInterface();
...
CRNET_EXPORT bool GetNetworkList(NetworkInterfaceList* networks,
                                 int policy);
...
CRNET_EXPORT std::string GetWifiSSID();
...
CRNET_EXPORT WifiPHYLayerProtocol GetWifiPHYLayerProtocol();
...
class CRNET_EXPORT ScopedWifiOptions {
 public:
...
CRNET_EXPORT std::unique_ptr<ScopedWifiOptions> SetWifiOptions(int options);
...
#endif  // MINI_CHROMIUM_SRC_CRNET_NETWORK_NETWORK_INTERFACES_H_