...
#ifndef MINI_CHROMIUM_SRC_CRNET_NETWORK_WIN_NETWORK_INTERFACES_WIN_H_
#define MINI_CHROMIUM_SRC_CRNET_NETWORK_WIN_NETWORK_INTERFACES_WIN_H_
...
struct WlanApiHandleTraits {
  ...
  static bool IsHandleValid(HANDLE handle) {
    return cr::win::HandleTraits::IsHandleValid(handle);
  }
  static HANDLE NullHandle() {
    return cr::win::HandleTraits::NullHandle();
  }
};

typedef cr::win::GenericScopedHandle<
  WlanApiHandleTraits,
  cr::win::DummyVerifierTraits> WlanHandle;
...
CRNET_EXPORT bool GetNetworkListImpl(
...
#endif   // MINI_CHROMIUM_SRC_CRNET_NETWORK_WIN_NETWORK_INTERFACES_WIN_H_