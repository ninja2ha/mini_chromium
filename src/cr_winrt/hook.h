...
#ifndef MINI_CHROMIUM_SRC_CRWINRT_HOOKER_H_
#define MINI_CHROMIUM_SRC_CRWINRT_HOOKER_H_
...
#include "cr_winrt/winrt_export.h"

namespace cr {
namespace winrt {

class CRWINRT_EXPORT Hooker {
 public:
  ...
  // enable: To enable hook.
  //
  bool CreateHook(void* target, void* detour, void** original, bool enable);

  // Warning: don not motify this structure!!
  struct CRWINRT_EXPORT ContextRegister {
  ...
  bool CreateContextHook(void* target, 
  ...
  //      HookHandle();
  //   }
  struct CRWINRT_EXPORT ScopedAvoidRecursionFlag {
   public:
...
#endif  // MINI_CHROMIUM_SRC_CRWINRT_HOOKER_H_
