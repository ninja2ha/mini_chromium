...
#ifndef MINI_CHROMIUM_SRC_CRBASE_INTERNAL_RAW_REF_PTR_MISMATCH_CHECKER_H_
#define MINI_CHROMIUM_SRC_CRBASE_INTERNAL_RAW_REF_PTR_MISMATCH_CHECKER_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_INTERNAL_RAW_REF_PTR_MISMATCH_CHECKER_H_
