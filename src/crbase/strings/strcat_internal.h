...
#ifndef MINI_CHROMIUM_SRC_CRBASE_STRINGS_STRCAT_INTERNAL_H_
#define MINI_CHROMIUM_SRC_CRBASE_STRINGS_STRCAT_INTERNAL_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_STRINGS_STRCAT_INTERNAL_H_
