...
// string.
CRBASE_EXPORT std::u16string ASCIIToUTF16(StringPiece ascii) 
    CR_WARN_UNUSED_RESULT;
...
// string.
CRBASE_EXPORT std::wstring ASCIIToWide(StringPiece ascii) CR_WARN_UNUSED_RESULT;

// Converts to 7-bit ASCII by truncating. The result must be known to be ASCII
// beforehand.
CRBASE_EXPORT std::string WideToASCII(WStringPiece wide) CR_WARN_UNUSED_RESULT;
