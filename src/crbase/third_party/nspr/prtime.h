...
#ifndef MINI_CHROMIUM_SRC_CRBASE_THIRD_PARTY_NSPR_PRTIME_H__
#define MINI_CHROMIUM_SRC_CRBASE_THIRD_PARTY_NSPR_PRTIME_H__
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_THIRD_PARTY_NSPR_PRTIME_H__
