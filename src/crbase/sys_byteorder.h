...
#ifndef MINI_CHROMIUM_SRC_CRBASE_SYS_BYTEORDER_H_
#define MINI_CHROMIUM_SRC_CRBASE_SYS_BYTEORDER_H_
...
#if defined(MINI_CHROMIUM_COMPILER_MSVC) && !defined(__clang__)
