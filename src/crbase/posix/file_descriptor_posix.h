...
#ifndef MINI_CHROMIUM_SRC_CRBASE_POSIX_FILE_DESCRIPTOR_POSIX_H_
#define MINI_CHROMIUM_SRC_CRBASE_POSIX_FILE_DESCRIPTOR_POSIX_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_POSIX_FILE_DESCRIPTOR_POSIX_H_