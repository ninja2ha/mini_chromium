...
#ifndef MINI_CHROMIUM_SRC_CRBASE_FILES_MEMORY_MAPPED_FILE_H_
#define MINI_CHROMIUM_SRC_CRBASE_FILES_MEMORY_MAPPED_FILE_H_
...
class CRBASE_EXPORT MemoryMappedFile {
 public:
  enum Access {
  ...
  bool Initialize(const FilePath& file_name) CR_WARN_UNUSED_RESULT {
  ...
  // return false.
  bool Initialize(File file, Access access) CR_WARN_UNUSED_RESULT;
  bool Initialize(File file) CR_WARN_UNUSED_RESULT {
  ...
  bool Initialize(File file, const Region& region, Access access)
      CR_WARN_UNUSED_RESULT;
  bool Initialize(File file, const Region& region) CR_WARN_UNUSED_RESULT {
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_FILES_MEMORY_MAPPED_FILE_H_