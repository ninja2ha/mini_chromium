...
#include "crbase/system/cpu_info.h"
...
#if defined(MINI_CHROMIUM_ARCH_CPU_X86_FAMILY)
CPUInfo::IntelMicroArchitecture CPUInfo::GetIntelMicroArchitecture() const {
  if (has_avx512_vnni()) {
    return AVX512_VNNI;
  }
  if (has_avx512_bw()) {
...
const CPUInfo& CPUInfo::GetInstanceNoAllocation() {
  static cr::NoDestructor<CPUInfo> g_cpu_instance;
