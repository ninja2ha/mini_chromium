...
template <typename T>
struct PointsToObject : std::is_object<internal::iter_value_t<T>> {};
...
template <typename T, 
          typename StringT = std::basic_string<internal::iter_value_t<T>>>
struct IsStringIterImpl
    : internal::disjunction<std::is_same<T, typename StringT::const_iterator>,
...
template <typename T>
struct IsStringIter
    : internal::conjunction<std::is_trivial<internal::iter_value_t<T>>, 
                                            IsStringIterImpl<T>> {};
...
struct IsArrayIter
    : internal::disjunction<std::is_same<T, typename ArrayT::const_iterator>,
...
struct IsVectorIter
    : internal::conjunction<
          internal::negation<std::is_same<iter_value_t<T>, bool>>,
...
struct IsContiguousIterator
    : internal::IsContiguousIteratorImpl<internal::remove_cvref_t<T>> {};
