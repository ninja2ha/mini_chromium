...
#ifndef MINI_CHROMIUM_SRC_CRBASE_CONTAINERS_LINKED_LIST_H_
#define MINI_CHROMIUM_SRC_CRBASE_CONTAINERS_LINKED_LIST_H_
...
class CRBASE_EXPORT LinkNodeBase {
 public:
  void RemoveFromList();
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_CONTAINERS_LINKED_LIST_H_