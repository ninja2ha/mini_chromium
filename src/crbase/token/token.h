...
#ifndef MINI_CHROMIUM_SRC_CRBASE_TOKEN_TOKEN_H_
#define MINI_CHROMIUM_SRC_CRBASE_TOKEN_TOKEN_H_
...
///struct TokenHash {
///  size_t operator()(const cr::Token& token) const {
///    return cr::HashInts64(token.high(), token.low());
///  }
///};

}  // namespace cr

#endif  // MINI_CHROMIUM_SRC_CRBASE_TOKEN_TOKEN_H_
