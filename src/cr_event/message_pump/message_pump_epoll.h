...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_PUMP_MESSAGE_PUMP_EPOLL_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_PUMP_MESSAGE_PUMP_EPOLL_H_
...
#include "cr_base_runtime/message_pump/message_pump.h"
#include "cr_base_runtime/message_pump/watchable_io_message_pump_posix.h"
...
///#include <optional>
///
///#include "cr_base/debug/stack_trace.h"
///#endif
...
class CRBASE_EXPORT MessagePumpEpoll : public MessagePump,
 ...
 public:
  ...
  class FdWatchController : public FdWatchControllerInterface {
   ...
   private:
    ...
    const RefPtr<Interest>& interest() const { return interest_; }
    ...
    const RefPtr<Interest>& AssignInterest(const InterestParams& params);
    void ClearInterest();
...
///#endif
  ...
  void UnregisterInterest(const RefPtr<Interest>& interest);
  ...
  cr::TimeTicks next_metrics_time_;
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_MESSAGE_PUMP_MESSAGE_PUMP_EPOLL_H_