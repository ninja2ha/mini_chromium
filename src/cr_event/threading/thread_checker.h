...
#ifndef MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_CHECKER_H_
#define MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_CHECKER_H_
...
#define CR_DETACH_FROM_THREAD(name) static_assert(true, "")
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_CHECKER_H_
