...
#ifndef MINI_CHROMIUM_SRC_CREVENT_THREADING_SIMPLE_THREAD_H_
#define MINI_CHROMIUM_SRC_CREVENT_THREADING_SIMPLE_THREAD_H_
...
class CREVENT_EXPORT SimpleThread : public PlatformThread::Delegate {
 public:
...
class CREVENT_EXPORT DelegateSimpleThread : public SimpleThread {
 public:
...
class CREVENT_EXPORT DelegateSimpleThreadPool
    : public DelegateSimpleThread::Delegate {
 public:
  typedef DelegateSimpleThread::Delegate Delegate;

  DelegateSimpleThreadPool(const DelegateSimpleThreadPool&) = delete;
  DelegateSimpleThreadPool& operator=(
      const DelegateSimpleThreadPool&) = delete;
 ...
 private:
  ...
  cr::Queue<Delegate*> delegates_;
  cr::Lock lock_;            // Locks delegates_
  WaitableEvent dry_;    // Not signaled when there is no work to do.
};

}  // namespace base

#endif  // MINI_CHROMIUM_SRC_CREVENT_THREADING_SIMPLE_THREAD_H_