...
#ifndef MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_CHECKER_IMPL_H_
#define MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_CHECKER_IMPL_H_
...
#include "cr_base/threading/sequence/sequence_token.h"
...
class CREVENT_EXPORT ThreadCheckerImpl {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_CHECKER_IMPL_H_