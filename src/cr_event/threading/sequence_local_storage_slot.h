...
#ifndef MINI_CHROMIUM_SRC_CREVENT_THREADING_SEQUENCE_LOCAL_STORAGE_SLOT_H_
#define MINI_CHROMIUM_SRC_CREVENT_THREADING_SEQUENCE_LOCAL_STORAGE_SLOT_H_
...
namespace internal {
CREVENT_EXPORT intptr_t GetNextSequenceLocalStorageSlotNumber();
}
...
//     static cr::NoDestructor<SequenceLocalStorageSlot<int>> sls_value;
...
//   task_runner->PostTask(CR_FROM_HERE, cr::BindOnce(&Write));
//   task_runner->PostTask(CR_FROM_HERE, cr::BindOnce(&Read));
// }
//
...
class SequenceLocalStorageSlot {
 ...
 private:
  ...
  const intptr_t slot_id_;
};

}  // namespace cr

#endif  // MINI_CHROMIUM_SRC_CREVENT_THREADING_SEQUENCE_LOCAL_STORAGE_SLOT_H_