...
#ifndef MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_H_
#define MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_H_
...
#include "cr_base/synchronization/atomic_flag.h"
...
class CREVENT_EXPORT Thread : PlatformThread::Delegate {
 public:
  class CREVENT_EXPORT Delegate {
   public:
    virtual ~Delegate() {}
 ...
 private:
  ...
  bool running_ = false;
  mutable cr::Lock running_lock_;  // Protects |running_|.

  // The thread's handle.
  PlatformThreadHandle thread_;
  mutable cr::Lock thread_lock_;  // Protects |thread_|.
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_THREADING_THREAD_H_