...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TIME_TICK_CLOCK_H_
#define MINI_CHROMIUM_SRC_CREVENT_TIME_TICK_CLOCK_H_
...
class CRBASE_EXPORT TickClock {
 public:
  ...
  static const TickClock* GetDefault();
};

}  // namespace cr

#endif  // MINI_CHROMIUM_SRC_CREVENT_TIME_TICK_CLOCK_H_