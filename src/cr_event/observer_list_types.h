...
#ifndef MINI_CHROMIUM_SRC_CREVENT_OBSERVER_LIST_TYPES_H_
#define MINI_CHROMIUM_SRC_CREVENT_OBSERVER_LIST_TYPES_H_
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_OBSERVER_LIST_TYPES_H_