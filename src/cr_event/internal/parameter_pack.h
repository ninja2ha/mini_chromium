...
#ifndef MINI_CHROMIUM_SRC_CREVENT_INTERNAL_PARAMETER_PACK_H_
#define MINI_CHROMIUM_SRC_CREVENT_INTERNAL_PARAMETER_PACK_H_
...
// export = ParameterPack

}  // namespace internal
}  // namespace cr

#endif  // MINI_CHROMIUM_SRC_CREVENT_INTERNAL_PARAMETER_PACK_H_
