...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TRAITS_BAG_H_
#define MINI_CHROMIUM_SRC_CREVENT_TRAITS_BAG_H_
...
#include "cr_event/internal/parameter_pack.h"
...
//       cr::trait_helpers::Exclude<UnwantedTrait1,
...
struct Exclude {
  template <typename T,
            std::enable_if_t<internal::ParameterPack<
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TRAITS_BAG_H_
