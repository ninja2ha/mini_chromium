...
#ifndef MINI_CHROMIUM_SRC_CREVENT_CONTAINERS_LINKED_LIST_H_
#define MINI_CHROMIUM_SRC_CREVENT_CONTAINERS_LINKED_LIST_H_
...
//      heap allocations.
//
// Q. How does cr::LinkedList implementation differ from std::list?
//
// A. Doubly-linked lists are made up of nodes that contain "next" and
//    "previous" pointers that reference other nodes in the list.
//
//    With cr::LinkedList<T>, the type being inserted already reserves
//    space for the "next" and "previous" pointers (cr::LinkNode<T>*).
...
class CREVENT_EXPORT LinkNodeBase {
 public:
  void RemoveFromList();
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_CONTAINERS_LINKED_LIST_H_