...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TIMER_TIMER_H_
#define MINI_CHROMIUM_SRC_CREVENT_TIMER_TIMER_H_
...
#include "cr_base/threading/sequence_checker_impl.h"
...
//
class CREVENT_EXPORT TimerBase {
 public:
  ...
  virtual void SetTaskRunner(RefPtr<SequencedTaskRunner> task_runner);
 ...
 private:
  ...
  RefPtr<SequencedTaskRunner> GetTaskRunner();
...
class CREVENT_EXPORT OneShotTimer : public internal::TimerBase {
 public:
...
class CREVENT_EXPORT RepeatingTimer : public internal::TimerBase {
 public:
...
class CREVENT_EXPORT RetainingOneShotTimer : public internal::TimerBase {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TIMER_TIMER_H_
