...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SINGLE_THREAD_TASK_RUNNER_THREAD_MODE_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SINGLE_THREAD_TASK_RUNNER_THREAD_MODE_H_
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SINGLE_THREAD_TASK_RUNNER_THREAD_MODE_H_
