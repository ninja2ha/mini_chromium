...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SIMPLE_TASK_EXECUTOR_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SIMPLE_TASK_EXECUTOR_H_

#include "cr_event/task/task_executor.h"
...
class CREVENT_EXPORT SimpleTaskExecutor : public TaskExecutor {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SIMPLE_TASK_EXECUTOR_H_
