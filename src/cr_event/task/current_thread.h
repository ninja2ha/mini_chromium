...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_CURRENT_THREAD_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_CURRENT_THREAD_H_
...
#include "cr_event/message_pump/message_pump_for_ui.h"
...
class CREVENT_EXPORT CurrentThread {
 public:
  ...
  // thread/sequence.
  class CREVENT_EXPORT DestructionObserver {
   public:
  ...
  class CREVENT_EXPORT ScopedAllowApplicationTasksInNativeNestedLoop {
   public:
...
class CREVENT_EXPORT CurrentUIThread : public CurrentThread {
 public:
...
class CREVENT_EXPORT CurrentIOThread : public CurrentThread {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_CURRENT_THREAD_H_
