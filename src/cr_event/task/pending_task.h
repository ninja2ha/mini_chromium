...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_PENDING_TASK_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_PENDING_TASK_H_
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_PENDING_TASK_H_