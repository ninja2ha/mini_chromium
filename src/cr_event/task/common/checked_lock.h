...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_CHECKED_LOCK_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_CHECKED_LOCK_H_

#include <memory>

#include "cr_base/synchronization/condition_variable.h"
#include "cr_base/synchronization/lock.h"

#include "cr_event/event_export.h"
#include "cr_event/task/common/checked_lock_impl.h"
...
class AnnotateAcquiredLockAlias {
 public:
  ...
  AnnotateAcquiredLockAlias(const CheckedLock& acquired_lock,
    ...
    CR_DCHECK(&acquired_lock == &lock_alias);
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_CHECKED_LOCK_H_
