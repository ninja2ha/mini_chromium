...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_INTRUSIVE_HEAP_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_INTRUSIVE_HEAP_H_

#include "cr_event/containers/intrusive_heap.h"

namespace cr {
namespace internal {

using HeapHandle = cr::HeapHandle;
...
struct IntrusiveHeapImpl {
  ...
  using type = cr::IntrusiveHeap<T, GreaterUsingLessEqual>;
};
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_COMMON_INTRUSIVE_HEAP_H_
