...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SINGLE_THREAD_TASK_EXECUTOR_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SINGLE_THREAD_TASK_EXECUTOR_H_
...
class CREVENT_EXPORT SingleThreadTaskExecutor {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SINGLE_THREAD_TASK_EXECUTOR_H_
