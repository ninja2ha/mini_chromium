...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_SEQUENCED_TASK_SOURCE_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_SEQUENCED_TASK_SOURCE_H_
...
class CREVENT_EXPORT SequencedTaskSource {
 public:
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_SEQUENCED_TASK_SOURCE_H_
