...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_SEQUENCE_MANAGER_IMPL_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_SEQUENCE_MANAGER_IMPL_H_
...
#include "cr_base/atomic/atomic_sequence_num.h"
#include "cr_base/functional/cancelable_callback.h"
#include "cr_base/containers/circular_deque.h"
...
#include "cr_event/message_pump/message_pump_type.h"
#include "cr_event/run_loop.h"
#include "cr_event/task/pending_task.h"
...
#include "cr_event/task/sequence_manager/associated_thread_id.h"
#include "cr_event/task/sequence_manager/enqueue_order.h"
#include "cr_event/task/sequence_manager/enqueue_order_generator.h"
#include "cr_event/task/sequence_manager/sequence_manager.h"
#include "cr_event/task/sequence_manager/task_queue_impl.h"
#include "cr_event/task/sequence_manager/task_queue_selector.h"
#include "cr_event/task/sequence_manager/thread_controller.h"
...
//
class CREVENT_EXPORT SequenceManagerImpl
 ...
 public:
  ...
  RefPtr<SequencedTaskRunner> GetTaskRunnerForCurrentTask() override;
  ...
  // TODO(alexclarke): Remove this as part of https://crbug.com/825327.
  RefPtr<SingleThreadTaskRunner> GetTaskRunner();
  ...
  const RefPtr<AssociatedThreadId>& associated_thread() const {
 ...
 protected:
  ...
  friend class ::cr::sequence_manager::SequenceManagerForTest;
 ...
 private:
  ...
  using NonNestableTaskDeque =
      CircularDeque<internal::TaskQueueImpl::DeferredNonNestableTask>;
  ...
  cr::subtle::Atomic32 add_queue_time_to_tasks_;
...
#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_SEQUENCE_MANAGER_IMPL_H_
