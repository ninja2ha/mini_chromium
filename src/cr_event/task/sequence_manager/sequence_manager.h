...
#ifndef MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_SEQUENCE_MANAGER_H_
#define MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_SEQUENCE_MANAGER_H_
...
#include "cr_event/message_pump/timer_slack.h"
...
class CREVENT_EXPORT SequenceManager {
 public:
  class Observer {
   public:
  ...
  struct CREVENT_EXPORT Settings {
    class Builder;
    ...
    const TickClock* clock = TickClock::GetDefault();
  ...
  virtual RefPtr<SequencedTaskRunner> GetTaskRunnerForCurrentTask() = 0;
  ...
  virtual void SetDefaultTaskRunner(
      RefPtr<SingleThreadTaskRunner> task_runner) = 0;
  ...
  RefPtr<TaskQueueType> CreateTaskQueueWithType(
  ...
  // Must be called on the main thread.
  virtual RefPtr<TaskQueue> CreateTaskQueue(
...
class CREVENT_EXPORT SequenceManager::Settings::Builder {
 public:
  Builder();
  ~Builder();
...
CREVENT_EXPORT std::unique_ptr<SequenceManager>
...
CREVENT_EXPORT std::unique_ptr<SequenceManager> CreateUnboundSequenceManager(
    SequenceManager::Settings settings = SequenceManager::Settings());

}  // namespace sequence_manager
}  // namespace cr

#endif  // MINI_CHROMIUM_SRC_CREVENT_TASK_SEQUENCE_MANAGER_SEQUENCE_MANAGER_H_
