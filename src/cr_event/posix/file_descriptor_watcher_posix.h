...
#ifndef MINI_CHROMIUM_SRC_CRBASE_RT_POSIX_FILES_FILE_DESCRIPTOR_WATCHER_POSIX_H_
#define MINI_CHROMIUM_SRC_CRBASE_RT_POSIX_FILES_FILE_DESCRIPTOR_WATCHER_POSIX_H_
...
#include "cr_base_runtime/runtime_export.h"
...
// the main queue).
class CRBASE_RT_EXPORT FileDescriptorWatcher {
 public:
  ...
  class Controller {
   ...
   private:
    ...
    // descriptor.
    const RefPtr<SingleThreadTaskRunner> io_thread_task_runner_;
    ...
    cr::WaitableEvent on_watcher_destroyed_;
 ...
 private:
  RefPtr<SingleThreadTaskRunner> io_thread_task_runner() const {
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_RT_POSIX_FILES_FILE_DESCRIPTOR_WATCHER_POSIX_H_