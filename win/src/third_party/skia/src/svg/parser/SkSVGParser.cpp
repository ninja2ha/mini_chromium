...
#include "src/svg/parser/SkSVGCircle.h"
#include "src/svg/parser/SkSVGClipPath.h"
#include "src/svg/parser/SkSVGDefs.h"
#include "src/svg/parser/SkSVGEllipse.h"
#include "src/svg/parser/SkSVGFeColorMatrix.h"
#include "src/svg/parser/SkSVGFilter.h"
#include "src/svg/parser/SkSVGG.h"
#include "src/svg/parser/SkSVGImage.h"
#include "src/svg/parser/SkSVGLine.h"
#include "src/svg/parser/SkSVGLinearGradient.h"
#include "src/svg/parser/SkSVGMask.h"
#include "src/svg/parser/SkSVGMetadata.h"
#include "src/svg/parser/SkSVGPath.h"
#include "src/svg/parser/SkSVGPolygon.h"
#include "src/svg/parser/SkSVGPolyline.h"
#include "src/svg/parser/SkSVGRadialGradient.h"
#include "src/svg/parser/SkSVGRect.h"
#include "src/svg/parser/SkSVGSVG.h"
#include "src/svg/parser/SkSVGStop.h"
#include "src/svg/parser/SkSVGSymbol.h"
#include "src/svg/parser/SkSVGText.h"
#include "src/svg/parser/SkSVGUse.h"
