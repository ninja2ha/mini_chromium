...
///Range StripAcceleratorChars(int flags, cr::string16* text) {
...
// static
///void Canvas::SizeStringFloat(const cr::string16& text,
///                             const FontList& font_list,
