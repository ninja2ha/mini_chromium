...
CRUI_EXPORT RectF IntersectRects(const RectF& a, const RectF& b);
CRUI_EXPORT RectF UnionRects(const RectF& a, const RectF& b);
CRUI_EXPORT RectF SubtractRects(const RectF& a, const RectF& b);
...
CRUI_EXPORT RectF BoundingRect(const PointF& p1, const PointF& p2);
