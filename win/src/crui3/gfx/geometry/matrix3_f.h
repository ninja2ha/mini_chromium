...
#ifndef MINI_CHROMIUM_SRC_CRUI_GFX_GEOMETRY_MATRIX3_F_H_
#define MINI_CHROMIUM_SRC_CRUI_GFX_GEOMETRY_MATRIX3_F_H_
...
CRUI_EXPORT Matrix3F MatrixProduct(const Matrix3F& lhs,
                                   const Matrix3F& rhs);
CRUI_EXPORT Vector3dF MatrixProduct(const Matrix3F& lhs,
                                    const Vector3dF& rhs);

}  // namespace gfx
}  // namespace crui

#endif  // MINI_CHROMIUM_SRC_CRUI_GFX_GEOMETRY_MATRIX3_F_H_
