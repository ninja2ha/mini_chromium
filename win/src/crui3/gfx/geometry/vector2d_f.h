...
CRUI_EXPORT double CrossProduct(const Vector2dF& lhs, const Vector2dF& rhs);

// Return the dot product of two vectors.
CRUI_EXPORT double DotProduct(const Vector2dF& lhs, const Vector2dF& rhs);

// Return a vector that is |v| scaled by the given scale factors along each
// axis.
CRUI_EXPORT Vector2dF ScaleVector2d(const Vector2dF& v,
                                    float x_scale,
                                    float y_scale);
