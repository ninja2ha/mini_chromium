...
CRUI_EXPORT bool DisplayInfosTouch(const DisplayInfo& a,
                                   const DisplayInfo& b);
...
// |        |        |
// +--------+--------+
CRUI_EXPORT DisplayPlacement CalculateDisplayPlacement(
...
CRUI_EXPORT int64_t SquaredDistanceBetweenRects(const gfx::Rect& ref,
                                                const gfx::Rect& rect);
