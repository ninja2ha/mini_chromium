...
///#include "crcomponents/viz/common/surfaces/frame_sink_id.h"
#include "crui/base/ui_export.h"
#include "crui/aura/scoped_enable_unadjusted_mouse_events.h"
#include "crui/aura/window.h"
#include "crui/base/cursor/cursor.h"
///#include "crui/base/ime/input_method_delegate.h"
...
///#include "crui/gfx/overlay_transform.h"
...
// aura.
class CRUI_EXPORT WindowTreeHost : ///public crui::internal::InputMethodDelegate,
                                   public crui::EventSource,
                                   public display::DisplayObserver/*,
                                   public crui::CompositorObserver*/ {
 public:
  ...
  ///crui::Compositor* compositor() { return compositor_.get(); }

  cr::WeakPtr<WindowTreeHost> GetWeakPtr();
  ...
  bool has_input_method() const { return false; }
  ...
  ///void SetSharedInputMethod(crui::InputMethod* input_method);

  // Overridden from ui::internal::InputMethodDelegate:
  ///crui::EventDispatchDetails DispatchKeyEventPostIME(crui::KeyEvent* event) final;
  ...
  // tree.
  virtual crui::EventSource* GetEventSource() = 0;
  ...
  std::unique_ptr<ScopedKeyboardHook> CaptureSystemKeyEvents(
      cr::Optional<cr::flat_set<crui::DomCode>> codes);

  // Returns a map of KeyboardEvent code to KeyboardEvent key values.
  virtual cr::flat_map<std::string, std::string> GetKeyboardLayoutMap() = 0;
 ...
 protected:
  ...
  virtual bool CaptureSystemKeyEventsImpl(
      cr::Optional<cr::flat_set<crui::DomCode>> dom_codes) = 0;
  ...
  virtual bool IsKeyLocked(crui::DomCode dom_code) = 0;

  virtual gfx::Rect GetTransformedRootWindowBoundsInPixels(
      const gfx::Size& size_in_pixels) const;

  const cr::ObserverList<WindowTreeHostObserver>& observers()
  ///const cr::ObserverList<WindowTreeHostObserver>::Unchecked& observers()
      const {
    return observers_;
  }
 ...
 private:
  ...
  ///cr::ObserverList<WindowTreeHostObserver>::Unchecked observers_;
  cr::ObserverList<WindowTreeHostObserver> observers_;

  std::unique_ptr<WindowEventDispatcher> dispatcher_;

  ///std::unique_ptr<crui::Compositor> compositor_;
  ...
  std::unique_ptr<crui::ViewProp> prop_;
  ...
  ///crui::InputMethod* input_method_;
