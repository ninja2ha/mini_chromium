...
#ifndef UI_AURA_WINDOW_LAYOUT_MANAGER_H_
#define UI_AURA_WINDOW_LAYOUT_MANAGER_H_
...
class CRUI_EXPORT WindowLayoutManager {
 public:
  WindowLayoutManager(const WindowLayoutManager&) = delete;
  WindowLayoutManager& operator=(const WindowLayoutManager&) = delete;

  WindowLayoutManager();
  virtual ~WindowLayoutManager();
...
#endif  // UI_AURA_WINDOW_LAYOUT_MANAGER_H_
