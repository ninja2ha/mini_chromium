...
class CRUI_EXPORT PlatformEventSource {
 public:
 ...
 protected:
  ///typedef cr::ObserverList<PlatformEventObserver>::Unchecked
  typedef cr::ObserverList<PlatformEventObserver>
 ...
 private:
  ...
  // is well-defined.
  ///typedef cr::ObserverList<PlatformEventDispatcher>::Unchecked
  typedef cr::ObserverList<PlatformEventDispatcher>
