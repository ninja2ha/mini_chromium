...
#include "crui/events/gesture_detection/snap_scroll_controller.h"
#include "crui/base/ui_export.h"

namespace crui {

class CRUI_EXPORT GestureProviderClient {
 public:
...
// event dispatch.
class CRUI_EXPORT GestureProvider {
 public:
  ...
  const crui::MotionEvent* current_down_event() const {
