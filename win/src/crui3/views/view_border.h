...
class CRUI_EXPORT Border {
 ...
 private:
  SkColor color_ = SK_ColorGRAY;//gfx::kPlaceholderColor;
};

// Convenience for creating a scoped_ptr with no Border.
CRUI_EXPORT std::unique_ptr<Border> NullBorder();

// Creates a border that is a simple line of the specified thickness and color.
CRUI_EXPORT std::unique_ptr<Border> CreateSolidBorder(int thickness,
                                                      SkColor color);

// Creates a border that is a rounded rectangle of the specified thickness and
// color.
CRUI_EXPORT std::unique_ptr<Border> CreateRoundedRectBorder(int thickness,
                                                            int corner_radius,
                                                            SkColor color);
CRUI_EXPORT std::unique_ptr<Border> CreateRoundedRectBorder(
    int thickness,
    int corner_radius,
...
// anything.
CRUI_EXPORT std::unique_ptr<Border> CreateEmptyBorder(
    const gfx::Insets& insets);
CRUI_EXPORT std::unique_ptr<Border> CreateEmptyBorder(int top,
                                                      int left,
                                                      int bottom,
                                                      int right);
...
// side.
CRUI_EXPORT std::unique_ptr<Border> CreateSolidSidedBorder(int top,
                                                           int left,
                                                           int bottom,
                                                           int right,
                                                           SkColor color);
...
CRUI_EXPORT std::unique_ptr<Border> CreatePaddedBorder(
...
///CRUI_EXPORT std::unique_ptr<Border> CreateBorderPainter(
