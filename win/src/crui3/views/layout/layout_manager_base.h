...
class CRUI_EXPORT LayoutManagerBase : public LayoutManager {
 public:
 ...
 protected:
  ...
  cr::Optional<gfx::Size> cached_minimum_size() const {
    return cached_minimum_size_;
  }
  void set_cached_minimum_size(
      const cr::Optional<gfx::Size>& minimum_size) const {
    cached_minimum_size_ = minimum_size;
  }
  const cr::Optional<gfx::Size>& cached_preferred_size() const {
    return cached_preferred_size_;
  }
  void set_cached_preferred_size(
      const cr::Optional<gfx::Size>& preferred_size) const {
    cached_preferred_size_ = preferred_size;
  }
  const cr::Optional<gfx::Size>& cached_height_for_width() const {
    return cached_height_for_width_;
  }
  void set_cached_height_for_width(
      const cr::Optional<gfx::Size>& height_for_width) const {
    cached_height_for_width_ = height_for_width;
  }
  const cr::Optional<gfx::Size>& cached_layout_size() const {
    return cached_layout_size_;
  }
  void set_cached_layout_size(
      const cr::Optional<gfx::Size>& layout_size) const {
 ...
 private:
  ...
  mutable cr::Optional<gfx::Size> cached_minimum_size_;
  mutable cr::Optional<gfx::Size> cached_preferred_size_;
  mutable cr::Optional<gfx::Size> cached_height_for_width_;
  mutable cr::Optional<gfx::Size> cached_layout_size_;
