...
void FullscreenHandler::SetFullscreenImpl(bool fullscreen) {
  ...
  if (!fullscreen_) {
    saved_window_info_.style = ::GetWindowLongW(hwnd_, GWL_STYLE);
    saved_window_info_.ex_style = ::GetWindowLongW(hwnd_, GWL_EXSTYLE);
  ...
  if (fullscreen_) {
    ...
    ::SetWindowLongW(hwnd_, GWL_STYLE, saved_window_info_.style);
    ::SetWindowLongW(hwnd_, GWL_EXSTYLE, saved_window_info_.ex_style);
