...
///CRUI_EXPORT const gfx::FontList& GetFont(int context, int style);
///CRUI_EXPORT SkColor GetColor(const views::View& view, int context, int style);
///CRUI_EXPORT int GetLineHeight(int context, int style);
