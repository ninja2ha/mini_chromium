...
class CRUI_EXPORT ClassMetaData {
 public:
  ...
  //      OperateOn(member);
  //    }
  class CRUI_EXPORT ClassMemberIterator
...
class CRUI_EXPORT MemberMetaDataBase {
 public:
  ...
  // metadata represents.
  virtual cr::string16 GetValueAsString(void* obj) const = 0;
  ...
  // metadata represents.
  virtual void SetValueAsString(void* obj, const cr::string16& new_value);
