...
class CRUI_EXPORT PaintInfo {
 public:
  ...
  static PaintInfo CreateRootPaintInfo(gfx::Canvas* root_canvas,
                                       const gfx::Size& size);
  ...
  const gfx::Canvas& context() const {
    return root_canvas_ ? *root_canvas_ : canvas_;
  }
 ...
 private:
  ...
  PaintInfo(gfx::Canvas* root_canvas, const gfx::Size& size);
