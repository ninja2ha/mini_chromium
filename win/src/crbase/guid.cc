...
std::string GenerateGUID() {
  ...
  cr::RandBytes(&sixteen_bytes, sizeof(sixteen_bytes));
...
bool IsValidGUID(cr::StringPiece guid) {
  return IsValidGUIDInternal(guid, false /* strict */);
}

bool IsValidGUID(cr::StringPiece16 guid) {
  return IsValidGUIDInternal(guid, false /* strict */);
}

bool IsValidGUIDOutputString(cr::StringPiece guid) {
