...
Time Time::FromJavaTime(int64_t ms_since_epoch) {
  return cr::Time::UnixEpoch() +
         cr::TimeDelta::FromMilliseconds(ms_since_epoch);
}
...
TimeTicks TimeTicks::UnixEpoch() {
  static cr::NoDestructor<UnixEpochSingleton> unix_epoch_singleton;
  return unix_epoch_singleton->unix_epoch();
}
