...
#ifndef MINI_CHROMIUM_SRC_CRBASE_COM_WIN_SCOPED_PROPVARIANT_H_
#define MINI_CHROMIUM_SRC_CRBASE_COM_WIN_SCOPED_PROPVARIANT_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_COM_WIN_SCOPED_PROPVARIANT_H_