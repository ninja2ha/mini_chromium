...
///size_t FastHashImpl(cr::Span<const uint8_t> data) {
...
///  return cr::internal::cityhash_v111::CityHash64(
///      reinterpret_cast<const char*>(data.data()), data.size());
///#else
///  return cr::internal::cityhash_v111::CityHash32(
///      reinterpret_cast<const char*>(data.data()), data.size());
///#endif
///}
...
///size_t FastHash(cr::Span<const uint8_t> data) {
...
uint32_t Hash(const std::string& str) {
  return PersistentHash(make_bytes_span(str));
}
