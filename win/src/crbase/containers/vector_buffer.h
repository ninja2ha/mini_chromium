...
#ifndef MINI_CHROMIUM_SRC_CRBASE_CONTAINERS_VECTOR_BUFFERS_H_
#define MINI_CHROMIUM_SRC_CRBASE_CONTAINERS_VECTOR_BUFFERS_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_CONTAINERS_VECTOR_BUFFERS_H_
