...
//    ...
//    private:
//     friend class cr::RefCounted<MyFoo>; // Allow destruction by RefCounted<>.
//     ~MyFoo();                        // Destructor must be private/protected.
//   };
//
//   void some_function() {
//     cr::RefPtr<MyFoo> foo = cr::MakeRefCounted<MyFoo>();
//     foo->Method(param);
...
//
//   {
//     cr::RefPtr<MyFoo> a = cr::MakeRefCounted<MyFoo>();
//     cr::RefPtr<MyFoo> b;
//
//     b.swap(a);
