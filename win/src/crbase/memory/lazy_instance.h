...
#ifndef MINI_CHROMIUM_SRC_CRBASE_MEMORY_LAZY_INSTANCE_H_
#define MINI_CHROMIUM_SRC_CRBASE_MEMORY_LAZY_INSTANCE_H_

#include <new>  // For placement new.

#include "crbase/atomic/atomicops.h"
#include "crbase/memory/lazy_instance_helpers.h"
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_MEMORY_LAZY_INSTANCE_H_