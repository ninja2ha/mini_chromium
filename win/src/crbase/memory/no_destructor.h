...
#ifndef MINI_CHROMIUM_SRC_CRBASE_MEMORY_NO_DESTRUCTOR_H_
#define MINI_CHROMIUM_SRC_CRBASE_MEMORY_NO_DESTRUCTOR_H_
...
class NoDestructor {
 ...
 private:
  ...
  //   static cr::NoDestructor<std::vector<int>> v({1, 2, 3});
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_MEMORY_NO_DESTRUCTOR_H_