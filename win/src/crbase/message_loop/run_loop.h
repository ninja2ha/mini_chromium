...
// url: https://github.com/chromium/chromium/blob/61.0.3117.2/base/run_loop.h

#ifndef MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_RUN_LOOP_H_
#define MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_RUN_LOOP_H_
...
class CRBASE_EXPORT RunLoop {
 public:
  ...
  //   run_loop.Run();
  cr::RepeatingClosure QuitClosure();
  cr::RepeatingClosure QuitWhenIdleClosure();
 ...
 private:
  ...
  cr::WeakPtrFactory<RunLoop> weak_factory_;
};

}  // namespace cr

#endif  // MINI_CHROMIUM_CRBASE_MESSAGE_LOOP_RUN_LOOP_H_
