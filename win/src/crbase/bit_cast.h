...
#ifndef MINI_CHROMIUM_SRC_CRBASE_MEMORY_BIT_CAST_H_
#define MINI_CHROMIUM_SRC_CRBASE_MEMORY_BIT_CAST_H_
...
#endif  // MINI_CHROMIUM_SRC_CRBASE_MEMORY_BIT_CAST_H_