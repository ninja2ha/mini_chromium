...
class CRUI_EXPORT WindowParentingClient {
 public:
...
// must not be NULL.
CRUI_EXPORT void SetWindowParentingClient(
    Window* window,
    WindowParentingClient* window_tree_client);

CRUI_EXPORT WindowParentingClient* GetWindowParentingClient(Window* window);
...
CRUI_EXPORT void ParentWindowWithContext(Window* window,
                                         Window* context,
