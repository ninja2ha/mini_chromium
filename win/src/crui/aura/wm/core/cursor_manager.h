...
class CRUI_EXPORT CursorManager : public aura::client::CursorClient,
 ...
 public:
  ...
  void SetCursorSize(crui::CursorSize cursor_size) override;
  crui::CursorSize GetCursorSize() const override;
  ...
  bool ShouldHideCursorOnKeyEvent(const crui::KeyEvent& event) const override;
 ...
 private:
  ...
  void CommitCursorSize(crui::CursorSize cursor_size) override;
  ...
  ///cr::ObserverList<aura::client::CursorClientObserver>::Unchecked observers_;
  cr::ObserverList<aura::client::CursorClientObserver> observers_;
