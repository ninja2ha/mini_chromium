...
class CRUI_EXPORT ActivationClient {
 public:
...
CRUI_EXPORT void SetActivationClient(aura::Window* root_window,
                                     ActivationClient* client);
CRUI_EXPORT ActivationClient* GetActivationClient(
    aura::Window* root_window);
CRUI_EXPORT const ActivationClient* GetActivationClient(
...
CRUI_EXPORT void SetHideOnDeactivate(aura::Window* window,
                                     bool hide_on_deactivate);
CRUI_EXPORT bool GetHideOnDeactivate(aura::Window* window);
