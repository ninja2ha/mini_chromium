...
///#include "crui/gfx/display_color_spaces.h"
...
CRUI_EXPORT bool CompareDisplayIds(int64_t id1, int64_t id2);
...
class CRUI_EXPORT Display final {
 public:
 ...
 private:
  ...
  cr::Optional<Rotation> panel_rotation_;
