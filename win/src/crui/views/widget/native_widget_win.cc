...
crui::GestureRecognizer* NativeWidgetWin::GetGestureRecognizer() { 
  return crui::views::ViewsDelegate::GetInstance()->gesture_recognizer();
}
...
bool NativeWidgetWin::HandleGestureEvent(crui::GestureEvent* event) { 
