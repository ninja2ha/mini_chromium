...
// changed.
class CRUI_EXPORT FlexLayout : public LayoutManagerBase {
 public:
  ...
  FlexLayout& SetDefault(const crui::ClassProperty<T>* key, U&& value) {
  ...
  template <class T, class U>
  FlexLayout& SetDefault(const crui::ClassProperty<T>* key, const U& value) {
 ...
 private:
  ...
  class PropertyHandler : public crui::PropertyHandler {
   public:
  ...
  cr::Optional<int> GetAvailableCrossAxisSize(
  ...
  // kMarginsKey).
  template <class T>
  T* GetDefault(const crui::ClassProperty<T>* key) const {
  ...
  // kMarginsKey).
  template <class T>
  FlexLayout& ClearDefault(const crui::ClassProperty<T>* key) {
