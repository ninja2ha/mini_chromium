...
class CRUI_EXPORT Painter {
 public:
  ...
  static std::unique_ptr<Painter> CreateSolidFocusPainter(
      SkColor color, const gfx::Insets& insets);
...
// same height.
///class CRUI_EXPORT HorizontalPainter : public Painter {
/// public:
///  HorizontalPainter(const HorizontalPainter&) = delete;
///  HorizontalPainter& operator=(const HorizontalPainter&) = delete;
///
