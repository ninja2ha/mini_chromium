...
class CRUI_EXPORT FocusRing : public View, public ViewObserver {
 public:
 ...
 private:
  ...
  cr::Optional<ViewPredicate> has_focus_predicate_;
};

CRUI_EXPORT SkPath GetHighlightPath(const View* view);
