...
#include "crui/views/rect_based_targeting_utils.h"
...
void NonClientView::SetAccessibleName(const cr::string16& name) {
...
///void NonClientView::GetAccessibleNodeData(crui::AXNodeData* node_data) {
///  node_data->role = ax::mojom::Role::kClient;
