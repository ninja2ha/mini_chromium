...
class CRUI_EXPORT Event {
 public:
  using Properties = cr::flat_map<std::string, std::vector<uint8_t>>;
  ...
  class DispatcherApi {
   public:
    ...
    void set_time_stamp(cr::TimeTicks time) { event_->time_stamp_ = time; }
  ...
  const cr::TimeTicks time_stamp() const { return time_stamp_; }
  ...
  bool IsEndingEvent() const {
    switch(type_) {
      ...
      case crui::ET_GESTURE_TAP_CANCEL:
      case crui::ET_GESTURE_END:
      case crui::ET_GESTURE_SCROLL_END:
 ...
 protected:
  Event(EventType type, cr::TimeTicks time_stamp, int flags);
  ...
  void set_time_stamp(cr::TimeTicks time_stamp) {
...
class CRUI_EXPORT CancelModeEvent : public Event {
 public:
  CancelModeEvent();
  ~CancelModeEvent() override;
};

class CRUI_EXPORT LocatedEvent : public Event {
 public:
  // Convenience function that casts |event| to a LocatedEvent if it is one,
  // otherwise returns null.
  static const crui::LocatedEvent* FromIfValid(const crui::Event* event) {
...
class CRUI_EXPORT MouseEvent : public LocatedEvent {
 public:
...
class CRUI_EXPORT MouseWheelEvent : public MouseEvent {
 public:
...
class CRUI_EXPORT TouchEvent : public LocatedEvent {
 public:
...
//
class CRUI_EXPORT KeyEvent : public Event {
 public:
...
class CRUI_EXPORT ScrollEvent : public MouseEvent {
 public:
