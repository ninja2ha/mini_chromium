...
class CRUI_EXPORT TouchDispositionGestureFilterClient {
 public:
...
class CRUI_EXPORT TouchDispositionGestureFilter {
 public:
 ...
 private:
  ...
  using GestureSequence = cr::queue<GestureEventDataPacket>;
  ...
  cr::queue<GestureSequence> sequences_;
