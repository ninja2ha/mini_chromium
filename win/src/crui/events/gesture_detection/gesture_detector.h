...
#include "crui/events/gesture_detection/velocity_tracker_state.h"
...
class CRUI_EXPORT GestureDetector {
 public:
  struct CRUI_EXPORT Config {
    Config();
    Config(const Config& other);
    ~Config();

    cr::TimeDelta longpress_timeout;
    cr::TimeDelta showpress_timeout;
    cr::TimeDelta double_tap_timeout;
    ...
    cr::TimeDelta double_tap_min_time;
    ...
    cr::TimeDelta two_finger_tap_timeout;
 ...
 private:
  ...
  cr::TimeDelta double_tap_timeout_;
  cr::TimeDelta two_finger_tap_timeout_;
  cr::TimeDelta double_tap_min_time_;
