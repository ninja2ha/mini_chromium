...
#include "crui/events/keycodes/dom/dom_key_data.inc"
...
#undef DOM_KEY_UNI
  ...
  static DomKey DeadKeyFromCombiningCharacter(int32_t combining_character) {
    CR_DCHECK(combining_character >= 0 && combining_character <= 0x10FFFF);
