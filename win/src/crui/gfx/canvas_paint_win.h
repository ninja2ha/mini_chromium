...
#include "crui/skia/ext/platform_canvas.h"
...
class CRUI_EXPORT CanvasSkiaPaint : public Canvas {
 public:
  CanvasSkiaPaint(const CanvasSkiaPaint&) = delete;
  CanvasSkiaPaint& operator=(const CanvasSkiaPaint&) = delete;
