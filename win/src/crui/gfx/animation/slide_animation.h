...
// }
class CRUI_EXPORT SlideAnimation : public LinearAnimation {
 public:
  ...
  virtual void SetSlideDuration(cr::TimeDelta duration);
  cr::TimeDelta GetSlideDuration() const { return slide_duration_; }
 ...
 private:
  ...
  cr::TimeDelta slide_duration_ = cr::TimeDelta::FromMilliseconds(120);
