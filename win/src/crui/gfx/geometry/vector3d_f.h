...
CRUI_EXPORT float DotProduct(const Vector3dF& lhs, const Vector3dF& rhs);

// Return a vector that is |v| scaled by the given scale factors along each
// axis.
CRUI_EXPORT Vector3dF ScaleVector3d(const Vector3dF& v,
                                    float x_scale,
                                    float y_scale,
                                    float z_scale);
...
CRUI_EXPORT float AngleBetweenVectorsInDegrees(const gfx::Vector3dF& base,
...
CRUI_EXPORT float ClockwiseAngleBetweenVectorsInDegrees(
