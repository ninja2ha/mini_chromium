...
class CRUI_EXPORT Transform {
 public:
  ...
  // and returns false.
  bool GetInverse(Transform* transform) const CR_WARN_UNUSED_RESULT;
  ...
  Transform GetCheckedInverse() const CR_WARN_UNUSED_RESULT;
  ...
  Transform InverseOrIdentity() const CR_WARN_UNUSED_RESULT;
  ...
  Point3F MapPoint(const Point3F& point) const CR_WARN_UNUSED_RESULT;
  // Maps [point.x(), point.y(), 0] to [result.x(), result.y(), discarded_z].
  PointF MapPoint(const PointF& point) const CR_WARN_UNUSED_RESULT;
  Point MapPoint(const Point& point) const CR_WARN_UNUSED_RESULT;
  ...
  Vector3dF MapVector(const Vector3dF& vector) const CR_WARN_UNUSED_RESULT;
  ...
  // be inverted.
  cr::Optional<PointF> InverseMapPoint(const PointF& point) const 
      CR_WARN_UNUSED_RESULT;
  cr::Optional<Point3F> InverseMapPoint(const Point3F& point) const 
      CR_WARN_UNUSED_RESULT;
  ...
  // point.
  cr::Optional<Point> InverseMapPoint(const Point& point) const
      CR_WARN_UNUSED_RESULT ;
  ...
  RectF MapRect(const RectF& rect) const CR_WARN_UNUSED_RESULT;
  Rect MapRect(const Rect& rect) const CR_WARN_UNUSED_RESULT;
  ...
  cr::Optional<RectF> InverseMapRect(const RectF& rect) const 
      CR_WARN_UNUSED_RESULT;
  cr::Optional<Rect> InverseMapRect(const Rect& rect) const 
      CR_WARN_UNUSED_RESULT;
  ...
  BoxF MapBox(const BoxF& box) const CR_WARN_UNUSED_RESULT;

  // Applies transformation on the given quad by applying the transformation
  // on each point of the quad.
  QuadF MapQuad(const QuadF& quad) const CR_WARN_UNUSED_RESULT;
  ...
  PointF ProjectPoint(const PointF& point,
                      bool* clamped = nullptr) const CR_WARN_UNUSED_RESULT;

  // Projects the four corners of the quad with ProjectPoint(). Returns an
  // empty quad if all of the vertices are clamped.
  QuadF ProjectQuad(const QuadF& quad) const CR_WARN_UNUSED_RESULT;
 ...
 private:
  ...
  explicit Transform(Matrix4F::UninitializedTag tag)
      : full_matrix_(true), matrix_(tag) {}

  PointF MapPointInternal(const Matrix4F& matrix, const PointF& point) const;
  Point3F MapPointInternal(const Matrix4F& matrix, const Point3F& point) const;

  Matrix4F GetFullMatrix() const;
  Matrix4F& EnsureFullMatrix();
