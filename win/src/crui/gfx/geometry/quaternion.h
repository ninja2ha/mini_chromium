...
#ifndef MINI_CHROMIUM_SRC_CRUI_GFX_GEOMETRY_QUATERNION_
#define MINI_CHROMIUM_SRC_CRUI_GFX_GEOMETRY_QUATERNION_
...
#endif  // MINI_CHROMIUM_SRC_CRUI_GFX_GEOMETRY_QUATERNION_
