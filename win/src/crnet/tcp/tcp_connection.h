...
#ifndef MINI_CHROMIUM_SRC_CRNET_SERVER_TCP_CONNECTION_H_
#define MINI_CHROMIUM_SRC_CRNET_SERVER_TCP_CONNECTION_H_
...
#endif  // MINI_CHROMIUM_SRC_CRNET_SERVER_TCP_CONNECTION_H_