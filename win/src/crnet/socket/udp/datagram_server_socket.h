...
#ifndef MINI_CHROMIUM_SRC_CRNET_SOCKET_TCP_DATAGRAM_SERVER_SOCKET_H_
#define MINI_CHROMIUM_SRC_CRNET_SOCKET_TCP_DATAGRAM_SERVER_SOCKET_H_
...
class CRNET_EXPORT DatagramServerSocket : public DatagramSocket {
 public:
  ...
  virtual int RecvFrom(cr::IOBuffer* buf,
                       int buf_len,
                       IPEndPoint* address,
  ...
  // If ERR_IO_PENDING is returned, the caller must keep |buf| and |address|
  // alive until the callback is called.
  virtual int SendTo(cr::IOBuffer* buf,
                     int buf_len,
...
#endif  // MINI_CHROMIUM_SRC_CRNET_SOCKET_TCP_DATAGRAM_SERVER_SOCKET_H_