...
#ifndef MINI_CHROMIUM_SRC_CRNET_BASE_IP_ADDRESS_H_
#define MINI_CHROMIUM_SRC_CRNET_BASE_IP_ADDRESS_H_
...
CRNET_EXPORT size_t CommonPrefixLength(const IPAddress& a1, const IPAddress& a2);

// Computes the number of leading 1-bits in |mask|.
CRNET_EXPORT size_t MaskPrefixLength(const IPAddress& mask);
...
#endif  // MINI_CHROMIUM_SRC_CRNET_BASE_IP_ADDRESS_H_